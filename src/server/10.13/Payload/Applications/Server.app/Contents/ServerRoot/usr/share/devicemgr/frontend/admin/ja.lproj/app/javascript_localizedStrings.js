...
var localizedStrings = { /* The name of the Web Application itself. */
  ...
  "_ios_restriction_string_Require Face ID authentication for AutoFill (supervised only, Face ID only)": "自動入力ではFace IDによる認証を要求（監視対象のみ、Face IDのみ）",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Automatically hide and show the Dock": "Dockを自動的に表示/非表示",
  ...
  "_generic_string_Restrict App Store to software updates only": "App Storeをソフトウェア・アップデートに制限",
  ...
  "_generic_string_Disable Siri setup during login": "ログイン時のSiri設定を無効にする",
  ...
  "_tvos_restriction_string_Allow iBooks Store (supervised only)": "iBooks Storeを許可（監視対象のみ）",
  ...
  "_tvos_airplay_knob_set_password_information": "* Apple TVの“情報”＞“AirPlay”セクションで設定したAirPlayパスワードがAirPlayのアクセス制限に使用されます",
  ...
  "_tvos_airplay_knob_set_password_warning": "Apple TVの“情報”＞“AirPlay”セクションのAirPlayパスワードが空白です。“パスワード”セキュリティタイプを選択するにはAirPlayパスワードが必要です。",
  ...
  "_content_caching_header_Data Path": "データパス",
  ...
  "_content_caching_header_Allow Tethered Caching": "インターネット接続を共有",
  "_content_caching_tethered_caching_description": "このコンピュータのインターネット接続とキャッシュしたコンテンツを、USB接続されたiOSデバイスと共有します。",
  "_layout_content_caching_ip_range_type_header_width": "100",
  "_layout_content_caching_first_ip_address_header_width": "150",
  "_content_caching_header_Client Listen Ranges": "クライアントリッスン範囲",
  ...
  "_content_caching_knob_set_ip_range_list_header_IP Address Type": "IPアドレスのタイプ",
  ...
  "_content_caching_header_Restrict To Listen Ranges": "リッスン範囲に制限",
  "_content_caching_listen_ranges_only_description": "リッスン範囲で指定されたクライアントにのみコンテンツを提供します",
  "_content_caching_header_Restrict Content To Local Network": "コンテンツをローカルネットワークに制限",
  ...
  "_content_caching_header_Restrict Peers To Local Network": "ピアをローカルネットワークに制限",
  "_content_caching_header_Peer Filter Ranges": "ピアフィルタ範囲",
  "_content_caching_header_Peer Listen Ranges": "ピアリッスン範囲",
  "_content_caching_header_Public Ranges": "パブリック範囲",
  ...
  "_region_name_Benin": "ベニン",
  "_region_name_Bermuda": "バミューダ諸島",
  ...
  "_region_name_Christmas Island": "クリスマス諸島 | クリスマス島",
  ...
  "_region_name_Montserrat": "モントセラト島",
  ...
  "_region_name_Saint Kitts and Nevis": "セントクリストファー・ネイビス",
  "_region_name_Saint Lucia": "セントルシア",
  "_region_name_Saint Martin (French part)": "Saint Martin (French part)",
  "_region_name_Saint Pierre and Miquelon": "サンピエール・ミクロン",
  ...
  "_region_name_South Georgia and the South Sandwich Islands": "南ジョージア島・南サンドイッチ諸島",
  ...
  "_region_name_Syrian Arab Republic": "シリア",
  ...
  "_language_name_Croatian": "クロアチア",
  "_language_name_Czech": "チェコ",
  "_language_name_Danish": "デンマーク",
  ...
  "_language_name_Hindi": "ヒンディー",
  "_language_name_Hiri Motu": "ヒリ・モトゥ語",
  "_language_name_Hungarian": "ハンガリー",
  "_language_name_Interlingua": "インターリングア語",
  "_language_name_Indonesian": "インドネシア",
  "_language_name_Interlingue": "インターリング語",
  "_language_name_Irish": "アイルランド",
  ...
  "_language_name_Norwegian": "ノルウェー",
  ...
  "_language_name_Northern Sami": "北サモス語",
  ...
  "_language_name_Phoenician": "フェニキア文字",
