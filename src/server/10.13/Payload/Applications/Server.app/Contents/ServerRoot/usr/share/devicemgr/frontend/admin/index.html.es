...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="/devicemanagement/console/sproutcore/foundation/es/3c1150af376045d5968a7e1bda4a57f64206c5cd/resources/images/favicon.ico" type="image/x-icon" />
    ...
    BUILD_INFO = {
      ...
      buildNumber: 'a7761d862adccef7b1a6d90827ee247033aa8892',
      buildLocale: 'en',

      // the logical URL at which we are built, which JavaScript can use
      // to compute relative URLs to other files.
      currentUrl: "/devicemanagement/console/admin/es/a7761d862adccef7b1a6d90827ee247033aa8892/index.html",

      // whether or not we are in relative URL mode.
      useRelativeUrls: false,

      styles: {
        x2: ["/devicemanagement/console/admin/es/a7761d862adccef7b1a6d90827ee247033aa8892/stylesheet@2x-packed.css"],
        normal: ["/devicemanagement/console/admin/es/a7761d862adccef7b1a6d90827ee247033aa8892/stylesheet-packed.css"]
      },

      images: {
        x2: ["/devicemanagement/console/admin/es/a7761d862adccef7b1a6d90827ee247033aa8892/packed-1@2x.png"],
        normal: ["/devicemanagement/console/admin/es/a7761d862adccef7b1a6d90827ee247033aa8892/packed-1.png"]
      }
    };
    </script>
...
if (SC.setupBodyClassNames) SC.setupBodyClassNames() ;
  ...
  <div style="display:none">    <script type="text/javascript" src="/devicemanagement/console/admin/es/a7761d862adccef7b1a6d90827ee247033aa8892/javascript-packed.js"></script></div>
  <script type="text/javascript" src="/devicemanagement/console/admin/common/a7761d862adccef7b1a6d90827ee247033aa8892/javascript-packed.js"></script>
