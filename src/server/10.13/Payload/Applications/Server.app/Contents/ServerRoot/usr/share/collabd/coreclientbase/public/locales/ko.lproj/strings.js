...
populateStrings({
	"_Loading": "로드 중...",
	"_UnsupportedBrowser.Warning": "사용자의 브라우저가 지원되지 않습니다.\n\nmacOS Server에서 Wiki Server 및 Xcode 서버를 사용하려면 최신 버전의 Safari, Chrome, Firefox 또는 Internet Explorer를 사용해야 합니다. iPod touch, iPhone 또는 iPad에서 이 페이지를 방문할 수도 있습니다.",
	...
	"_Errors.Wiki.Calendar.Disabled": "캘린더가 비활성화되었습니다. 이 Wiki의 소유자가 Wiki 설정에서 캘린더를 활성화할 수 있습니다.",
