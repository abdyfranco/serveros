...
populateStrings({
	...
	"_Server.About.Dialog.Title": "Acerca de macOS Server",
	...
	"_Sources.Me.Description": "Gestiona tu perfil.",
	"_Sources.MyActivity.Title": "Mi actividad",
	"_Sources.MyActivity.Description": "Consulta tu actividad en tiempo real.",
	"_Sources.MyDocuments.Title": "Mis documentos",
	"_Sources.MyDocuments.Description": "Visualiza y edita tus documentos personales.",
	"_Sources.MyFavorites.Title": "Mis favoritos",
	"_Sources.MyFavorites.Description": "Consulta las páginas y las personas que más te interesan.",
	"_Sources.Activity.Title": "Actividad",
	"_Sources.Activity.Description": "Realiza un seguimiento en tiempo real de la actividad de las personas y las wikis que te interesen.",
	"_Sources.Projects.Title": "Todas las wikis",
	"_Sources.Projects.Description": "Comunícate y colabora con los miembros del equipo.",
	"_Sources.People.Title": "Todas las personas",
	"_Sources.People.Description": "Visualiza los blogs y la actividad de otras personas.",
	"_Sources.Home.Title": "Inicio",
	"_Sources.Home.Description": "Visualiza la página de inicio del servidor.",
	"_Login.LoggedInUser": "Sesión iniciada (%@)",
	"_Login.Unexpected.Error": "El inicio de sesión ha fallado debido a un error inesperado. Inténtalo de nuevo.",
	"_Logout.Confirm.Dialog.Title": "Cerrar sesión",
	"_Logout.Confirm.Dialog.Description": "¿Seguro que quieres cerrar la sesión?",
	...
	"_Deleted.Error.CouldNotRestore": "No se ha podido restaurar el contenido. Inténtalo de nuevo.",
	"_Load.Error.CouldNotLoadIngoFromServer": "No se ha podido cargar la información de la versión desde el servidor. Inténtalo de nuevo.",
