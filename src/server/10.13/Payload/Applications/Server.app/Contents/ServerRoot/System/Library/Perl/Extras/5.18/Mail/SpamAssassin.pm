...
if ('$LastChangedDate: 2015-04-28 03:54:45 -0400 (Tue, 28 Apr 2015) $' =~ ':') {
  # Subversion keyword "$LastChangedDate: 2015-04-28 03:54:45 -0400 (Tue, 28 Apr 2015) $" has been successfully expanded.
  # Doesn't happen with automated launchpad builds:
  # https://bugs.launchpad.net/launchpad/+bug/780916
  $SUB_VERSION = (split(/\s+/,'$LastChangedDate: 2015-04-28 03:54:45 -0400 (Tue, 28 Apr 2015) $ updated by SVN'))[1];
}


if (defined $IS_DEVEL_BUILD && $IS_DEVEL_BUILD) {
  if ('$LastChangedRevision: 1676427 $' =~ ':') {
    # Subversion keyword "$LastChangedRevision: 1676427 $" has been successfully expanded.
    push(@EXTRA_VERSION, ('r' . qw{$LastChangedRevision: 1676427 $ updated by SVN}[1]));
  } else {
...
Defaults to "/Applications/Server.app/Contents/ServerRoot/".
...
"/Library/Server/Mail/Data/scanner/spamassassin".
...
sub new {
  ...
  $self->{PREFIX}		||= '/Applications/Server.app/Contents/ServerRoot/';
  $self->{DEF_RULES_DIR}	||= '/Library/Server/Mail/Data/scanner/spamassassin/3.004000';
  $self->{LOCAL_RULES_DIR}	||= '/Library/Server/Mail/Config/spamassassin';
  $self->{LOCAL_STATE_DIR}	||= '/Library/Server/Mail/Data/scanner/spamassassin';
