...
populateStrings({
	...
	"_NavigationSidebar.All.People": "所有联系人",
	"_NavigationSidebar.RecentlyViewed.Title": "最近使用的文稿",
	"_Login.LogIn": "登录",
	"_Login.LogOut": "退出",
	"_Login.LogIn_Sidebar": "登录边栏",	
	"_Login.LogOut_Sidebar": "退出边栏",		
	...
	"_Document.Sidebar.Tags.Add.Name": "添加标记",
	"_Document.Sidebar.Tags.SuggestedTags": "建议的标记",
	"_Document.Sidebar.Tags.NoSuggestions": "没有建议",	
	...
	"_Error.General.Database.Unabailable": "数据库不可用。",
	"_Error.General.Database.Contact": "请联系您的管理员或稍后再试一次。",
	"_Error.People.Unauthenticated": "请登录以查看“所有联系人”。",
	"_Error.AllActivity.Unauthenticated": "请登录以查看“所有活动”。",
	...
	"_Accessibility.group.history": "历史记录群组",
	"_Accessibility.group.comment": "注释群组",
	"_Accessibility.group.related": "相关群组",
	"_Accessibility.group.sidebar": "边栏群组",
	"_Accessibility.group.sharing": "共享群组",
	"_Accessibility.group.suggested": "建议群组",
	"_Accessibility.group.editToolBar": "编辑工具栏",
	"_Accessibility.color.selected": "已选择",
	"_Accessibility.Acls.All": "所有用户 ACL",
	"_Accessibility.Added.All": "已添加用户 ACL",
	"_Accessibility.Navigation.Bar": "导航栏"
});
