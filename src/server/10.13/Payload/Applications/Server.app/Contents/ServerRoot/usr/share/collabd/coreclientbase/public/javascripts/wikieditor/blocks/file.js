...
FileBlockDelegate.prototype = {
	...
	addBlock: function() {		
		...
		// Specific case for iPad when unauthenticated user is trying to upload a document
		if (browser().isMobileSafari() && CC.meta('x-apple-user-logged-in') == "false") {
				// Making sure we're getting the right owner-guid
				pageGUID = document.querySelectorAll('[data-guid]')[0].getAttribute('data-guid');
		}				
