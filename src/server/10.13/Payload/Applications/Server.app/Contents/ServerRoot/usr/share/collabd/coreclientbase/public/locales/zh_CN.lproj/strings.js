...
populateStrings({
	"_Loading": "正在载入…",
	"_UnsupportedBrowser.Warning": "您的浏览器不受支持。\n\n需要最新版本的 Safari、Chrome、Firefox 或 Internet Explorer 才能使用 macOS Server 上的 Wiki 服务器和 Xcode 服务器。您也可以从 iPod touch、iPhone 或 iPad 访问此页面。",
	...
	"_General.No.Results.Found": "找不到结果",
	"_General.LastModified.Format": "%@2更新于 %@1",
	...
	"_EntityTitle.LastModified": "%@2更新于 %@1",
	...
	"_Search.LastModified.Subtitle.Format": "%@2更新于 %@1",
