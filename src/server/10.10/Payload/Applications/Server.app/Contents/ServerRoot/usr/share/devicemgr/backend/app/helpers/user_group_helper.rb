...
module UserGroupHelper
  ...
  def self.find_all(remote_guid, selected_item_id = nil)
    ...
    if !record_array.include? selected_item_id
      record_array << selected_item_id if UserGroup.find_by_id(selected_item_id)
    end
  ...
  def self.find_matching(incoming_request, remote_guid, selected_item_id = nil)
    ...
    if !user_group_records.include? selected_item_id
      user_group_records << selected_item_id if UserGroup.find_by_id(selected_item_id)
    end
