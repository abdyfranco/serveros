...
populateStrings({
	...
	"_Document.Sidebar.Tags.Add.Name": "加入標記文字欄位",
	...
	"_GearMenu.General.Replace": "取代檔案⋯",
	...
	"_Error.People.Disabled": "檢視此伺服器上所有已停用的人員。",
	"_Error.Projects.Disabled": "檢視此伺服器上所有已停用的計畫案。",
	"_Error.AllActivity.Disabled": "檢視此伺服器上所有已停用的活動。",
	...
	"_Control.Close": "關閉",
	"_Control.Plus": "加",
	"_Control.ShowDiff": "顯示差異",		
	"_Control.Pagination.ShowAll": "顯示全部",
	"_Control.Gear": "動作選單",
	"_Control.MenuNavigation": "導覽",
	"_Control.AccessRole.Popup": "彈出式選單",
	"_Control.Switch.On": "開啟",
	"_Control.Switch.Off": "關閉",	
