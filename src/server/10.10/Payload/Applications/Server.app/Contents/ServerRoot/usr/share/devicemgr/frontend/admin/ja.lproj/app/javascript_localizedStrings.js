...
var localizedStrings = { /* The name of the Web Application itself. */
  ...
  "_Show Save Changes Confirmation Description": "この操作により、変更された設定がデバイスにプッシュされます。",
  ...
  "_Show Save Changes Confirmation Message": "変更内容を保存しますか？",
  ...
  "_task_step_vpp_status_no_copies_available": "コピーがありません",
  ...
  "_server_not_found_message": "プロファイルサーバが見つかりません",
  ...
  "_server_timed_out_description": "プロファイルサーバがあるネットワークおよびインターネットに接続していることを確認してください。",
  ...
  "_server_not_available_message": "プロファイルサーバを利用できません",
  ...
  "_show_save_changes_confirmation_description_for_library_item": "この操作により、設定がデバイスにプッシュされることがあります。",
  ...
  /*  */
  "_new_task_passcodes_did_not_match_warning": "パスコードが一致しませんでした",
  ...
  /*  */
  "_new_task_you_must_select_one_or_more_devices": "このコマンドを実行する前に 1 つ以上のデバイスを選択してください。",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Allow Screenshot": "スクリーンショットを許可",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Access Point Password": "アクセスポイント・パスワード",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_This configuration profile has no recipents, it will not be distributed": "この構成プロファイルは受信者がいないため、配布されません",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Access Point Name (APN)": "アクセスポイント名（APN）",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_The user name to connect to the access point": "アクセスポイントに接続するためのユーザ名",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_usernames": "ユーザ名",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_The name of the carrier (GPRS) access point": "キャリア（GPRS）アクセスポイントの名前",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_The password to connect to the access point": "アクセスポイントに接続するためのパスワード",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Access Point User Name": "アクセスポイント・ユーザ名",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Allow installing apps": "アプリケーションのインストールを許可",

  /* This is a generic string used one or more times in the app. */
  "_generic_string_Allow removing apps": "App の削除を許可（監視対象のみ）",

  /* This is a generic string used one or more times in the app. */
  "_restrictions_string_Allow internet results in Spotlight": "Spotlight でインターネット検索結果を許可",
  "_restrictions_string_Allow configuring restrictions": "制限の構成を許可（監視対象のみ）",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Allow screen capture": "スクリーンショットを許可",
  ...
  "_generic_string_Restrict App Store to software updates only": "App Store をソフトウェア・アップデートのみに制限",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Go to My Devices": "自分のデバイスに移動",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Allow sending diagnostic and usage data to Apple": "Apple への診断情報および使用状況データの送信と、クラッシュデータおよび統計情報の App デベロッパとの共有を許可",
  ...
  "_generic_string_Allow My Photo Stream (disallowing can cause data loss)": "“自分のフォトストリーム”を許可（許可しないとデータ損失の可能性あり）",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Upgrade to iOS 5 and re-enroll this device to enable enterprise application distribution": "エンタープライズ App の配布を有効にするには、iOS 5 にアップグレードしてこのデバイスを再度登録します",

  /* This is a generic string used one or more times in the app. */
  "_generic_string_Re-enroll this device to enable enterprise application distribution": "エンタープライズ App の配布を有効にするには、このデバイスを再度登録します",

  /* This is a generic string used one or more times in the app. */
  "_generic_string_Allow Siri": "Siri を許可",

  /* This is a generic string used one or more times in the app. */
  "_generic_string_Allow Siri while device locked": "デバイスのロック中に Siri を許可",
  ...
  /*  */
  "_no_item_view_no_somethings_widget": "ウィジェットがありません",

  "_no_item_view_no_somethings_members": "メンバーがいません",
  ...
  /*  */
  "_no_item_view_no_somethings_device": "デバイスがありません",

  "_no_item_view_no_airplay_destinations": "AirPlay 出力先がありません",

  "_no_item_view_no_somethings_apps": "アプリケーションがありません",
  ...
  /*  */
  "_no_item_view_no_somethings_system_application": "アプリケーションがありません",
  ...
  /*  */
  "_no_item_view_no_somethings_printer": "プリンタがありません",
  ...
  /*  */
  "_no_item_view_no_somethings_user": "ユーザがいません",
  ...
  /*  */
  "_no_item_view_no_somethings_user_group": "グループがありません",
  "_no_item_view_no_somethings_vpp_user_group": "VPP 対応のグループがありません",
  ...
  /*  */
  "_no_item_view_no_somethings_tasks_active": "実行中のタスクがありません",

  /*  */
  "_item_list_loading_tasks_complete": "完了したタスクを読み込み中...",

  /*  */
  "_no_item_view_no_somethings_device_group": "デバイスグループがありません",
  ...
  "_generic_string_General (OS X Only)": "一般（OS X のみ）",
  ...
  "_generic_string_Allow Podcasts (supervised only)": "Podcast を許可（監視対象のみ）",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Allow Passbook while device locked": "ロック画面での Passbook 通知を許可",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Delete Application Confirmation": "アプリケーションを削除しますか？",
  "_generic_string_Delete Apps Confirmation": "App を削除しますか？",

  /* This is a generic string used one or more times in the app. */
  "_generic_string_This application will be removed from all devices.": "この App は、すべてのデバイスから削除されます。",
  "_generic_string_The apps will be removed from all devices.": "これらの App は、すべてのデバイスから削除されます。",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_This book will be removed from all devices.": "このブックは、すべてのデバイスから削除されます。",
  "_generic_string_The books will be removed from all devices.": "これらのブックは、すべてのデバイスから削除されます。",
  ...
  "_generic_string_FileVault (OS X Only)": "FileVault（OS X のみ）",
  ...
  "_generic_string_Choose in-house iOS enterprise apps from your library": "ライブラリからインハウス iOS エンタープライズ App を選択",
  ...
  "_assign_inhouse_enterprise_apps_description": "プロファイルマネージャに追加されたインハウス iOS エンタープライズ App を割り当てることができます",
  ...
  "generic_string_authorized_users_exceeds_available_licenses_for_single_app": "購入した %@ のコピー数では、このグループのユーザ総数に足りません。App は、ユーザが“VPP 管理配布”の登録を受け入れた時系列順に従って割り当てられます。",
  "generic_string_authorized_users_exceeds_available_licenses_for_multiple_apps": "購入した %@ のコピー数の App では、このグループのユーザ総数に足りません。App は、ユーザが“VPP 管理配布”の登録を受け入れた時系列順に従って割り当てられます。",
  "generic_string_authorized_users_exceeds_available_licenses_for_single_book": "購入した %@ のコピー数では、このグループのユーザ総数に足りません。ブックは、ユーザが“VPP 管理配布”の登録を受け入れた時系列順に従って割り当てられます。",
  "generic_string_authorized_users_exceeds_available_licenses_for_multiple_books": "購入した %@ のコピー数の App では、このグループのユーザ総数に足りません。ブックは、ユーザが“VPP 管理配布”の登録を受け入れた時系列順に従って割り当てられます。",
  ...
  "_generic_string_Allow Pairing": "ペアリングを許可",
  "_generic_string_Enable the iOS device to be paired with a Mac": "iOS デバイスを Mac とペアリングできるようにする",
  "_generic_string_Require credentials for enrollment": "登録に資格情報を要求",
  "_generic_string_Setup Assistant Options": "設定アシスタントのオプション",
  "_generic_string_Choose which options to show in the assistant": "アシスタントに表示するオプションを選択",
  ...
  "_generic_string_Push VPP Apps": "VPP App をプッシュ",
  "_generic_string_Push VPP Books": "VPP ブックをプッシュ",

  // push OS X enterprise apps
  "_library_item_action_Push OS X in-house enterprise apps": "OS X エンタープライズ App をプッシュ",
  "_library_item_action_push_osx_apps_No OS X in-house enterprise apps available": "入手可能な OS X インハウスエンタープライズ App はありません。",
  "_generic_string_The selected apps will be pushed to all eligible devices": "選択した App は適格なすべてのデバイスにプッシュされます。",

  "_generic_string_Choose VPP Apps to push": "プッシュする VPP App を選択",
  "_generic_string_Choose VPP Books to push": "プッシュする VPP ブックを選択",
  "_generic_string_The selected apps will be pushed to all eligible devices of enrolled users.": "選択した App は登録したユーザのすべての適格なデバイスにプッシュされます。",
  "_generic_string_The selected apps will be pushed to all eligible devices of the enrolled user.": "選択した App は登録したユーザのすべての適格なデバイスにプッシュされます。",
  ...
  "_generic_string_No VPP Apps assigned": "VPP App が割り当てられていません",
  "_generic_string_No VPP Books assigned": "VPP ブックが割り当てられていません",
  "_generic_string_Select All": "すべて選択",
  "_generic_string_No VPP apps assigned to this user.": "このユーザに VPP App が割り当てられていません。",
  "_generic_string_No VPP apps assigned to this group.": "このグループに VPP App が割り当てられていません。",
  "_generic_string_No VPP books assigned to this user.": "このユーザに VPP ブックが割り当てられていません。",
  "_generic_string_No VPP books assigned to this group.": "このグループに VPP ブックが割り当てられていません。",
  ...
  "_generic_string_No eligible devices.": "適格なデバイスがありません。",
  ...
  "_locations_sidebar_item_display_name": "場所",
  ...
  "_directory_string_All members of these groups will have administrator privileges on this computer": "これらのグループのすべてのメンバーに対して、このコンピュータの管理者権限が与えられます",
  ...
  /* IKEv2 VPN */
  "_vpn_type_string_IKEv2": "IKEv2（iOS のみ）",
  ...
  "_vpn_type_string_always_on": "VPN を常に入（監視対象のみ）",
