...
var localizedStrings = { /* The name of the Web Application itself. */
  ...
  "_groups_in_about_root_item_in_user_groups": "在分配了“访问限制”、“设置”、“应用程序”或“图书”，或者 VPP 已启用的群组中",
  ...
  /* This is a generic string used one or more times in the app. */
  "_restrictions_string_Allow internet results in Spotlight": "允许 Spotlight 显示互联网结果",
  "_restrictions_string_Allow configuring restrictions": "允许配置访问限制（仅限被监督的设备）",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Allow sending diagnostic and usage data to Apple": "允许将诊断和用量数据发送给 Apple，并与应用程序开发者共享崩溃数据和统计数据",
  ...
  "_generic_string_Allow managed apps to store data in iCloud": "允许被管理的应用程序将数据储存到 iCloud",
  ...
  "_no_item_view_inactive_user_group_members": "只有在分配了“访问限制”、“设置”、“应用程序”或“图书”，或者启用 VPP 支持后才能同步成员",
  ...
  "_generic_string_Allow Podcasts (supervised only)": "允许“播客”（仅限被监督的设备）",
  ...
  "_general_string_The app to run in Single App Mode (supervised only)": "要在“单应用程序模式”中运行的应用程序（仅限被监督的设备）",
  /* This is a generic string used one or more times in the app. */
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_This book will be removed from all devices.": "图书将从所有设备中移除。",
  "_generic_string_The books will be removed from all devices.": "图书将从所有设备中移除。",
  ...
  "_generic_string_app_count_singular_and_size_fmt_KB": "1 个应用程序，%@1 KB",
  "_generic_string_app_count_and_size_fmt_KB": "%@1 个应用程序，%@2 KB",
  "_generic_string_app_count_singular_and_size_fmt_MB": "1 个应用程序，%@1 MB",
  "_generic_string_app_count_singular_and_decimal_size_fmt_MB": "1 个应用程序，%@1.%@2 MB",
  "_generic_string_app_count_and_size_fmt_MB": "%@1 个应用程序，%@2 MB",
  "_generic_string_app_count_and__decimal_size_fmt_MB": "%@1 个应用程序，%@2.%@3 MB",
  "_generic_string_app_count_singular_and_size_fmt_GB": "1 个应用程序，%@1 GB",
  "_generic_string_app_count_singular_and_decimal_size_fmt_GB": "1 个应用程序，%@1.%@2 GB",
  "_generic_string_app_count_and_size_fmt_GB": "%@1 个应用程序，%@2 GB",
  "_generic_string_app_count_and_decimal_size_fmt_GB": "%@1 个应用程序，%@1.%@2 GB",
  ...
  "_generic_string_Choose in-house iOS enterprise apps from your library": "从资源库选取内部 iOS 企业级应用程序",
  ...
  "_assign_unified_apps_description": "您可以分配通过“批量购买计划”购买的应用程序或者添加到“描述文件管理器”的内部 iOS 企业级应用程序。",
  "_assign_unified_apps_description_no_device_management": "您可以分配使用“批量购买计划”购买的应用程序。",
  "_assign_inhouse_enterprise_apps_description": "您可以分配添加到“描述文件管理器”的内部 iOS 企业级应用程序",
  ...
  "_generic_string_profile_manager_apps_feature_description": "描述文件管理器能够方便地将通过“批量购买计划”购买的应用程序分配和分发给用户和群组。您还可以将适用于 iOS 和 OS X 的企业级应用程序分发给已注册设备。",
  ...
  "_application_detail_unavailable_from_itunes_store": "不可再从 App Store 中获取有关此应用程序的信息",
  ...
  "generic_string_authorized_users_exceeds_available_licenses_for_single_book": "您购买的“%@”的副本不足，无法提供给此群组中的所有用户。图书会根据用户接受 VPP 已管理的分发注册的时间顺序进行分配。",
  "generic_string_authorized_users_exceeds_available_licenses_for_multiple_books": "您购买的 %@ 个应用程序的副本不足，无法提供给此群组中的所有用户。图书会根据用户接受 VPP 已管理的分发注册的时间顺序进行分配。",
  ...
  "_generic_string_Send Diagnostics": "应用程序分析",
  ...
  "_generic_string_Push VPP Books": "推送 VPP 图书",

  // push OS X enterprise apps
  "_library_item_action_Push OS X in-house enterprise apps": "推送 OS X 企业级应用程序",
  "_library_item_action_push_osx_apps_No OS X in-house enterprise apps available": "无可用的 OS X 内部企业级应用程序。",
  "_generic_string_The selected apps will be pushed to all eligible devices": "所选应用程序将被推送到所有合格设备上。",

  "_generic_string_Choose VPP Apps to push": "选取要推送的 VPP 应用程序",
  "_generic_string_Choose VPP Books to push": "选取要推送的 VPP 图书",
  ...
  "_generic_string_No VPP Books assigned": "无分配的 VPP 图书",
  ...
  "_generic_string_No VPP books assigned to this user.": "无分配到此用户的 VPP 图书。",
  "_generic_string_No VPP books assigned to this group.": "无分配到此群组的 VPP 图书。",
  ...
  "_generic_string_Allow modifying cellular data settings (supervised only)": "允许修改蜂窝移动数据应用程序设置（仅限被监督的设备）",
  ...
  "_ad_cert_Machine": "机器",
  "_ad_cert_User": "用户",
  "_ad_cert_string_Allow access to all applications": "允许访问所有应用程序",
  "_ad_cert_string_Allow all applications to access the certificate in the keychain": "允许所有应用程序访问钥匙串中的证书",
  ...
  "_content_filter_plugin_type_filter_name_description": "在应用程序和设备上显示过滤器的名称",
  ...
  "_directory_string_The directory server username": "目录服务器用户名称",
  ...
  /* IKEv2 VPN */
  "_vpn_type_string_IKEv2": "IKEv2（仅限 iOS）",
  ...
  "_vpn_type_string_always_on": "始终打开 VPN（仅限被监督的设备）",
  ...
  "_vpn_ikev2_eap_authentication_type_password": "用户名称/密码",
  ...
  "_vpn_always_on_allow_captive_web_sheet": "允许来自所有俘获型网络表单（包括 VPN 隧道）的流量",
  "_vpn_always_on_allow_all_captive_network_plugins": "允许来自所有俘获型联网应用程序（包括 VPN 隧道）的流量",
  "_vpn_always_on_allow_whitelist_captive_network_plugins_header": "俘获型联网应用程序捆绑包标识符",
  "_vpn_always_on_allow_whitelist_captive_network_plugins_description": "除了 VPN 隧道外，也允许来自这些应用程序的流量",
  "_vpn_always_on_captive_network_app_bundle_id_placeholder": "俘获型网络应用程序捆绑包 ID",
