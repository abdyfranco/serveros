...
PM_LOG_PATH       = "#{PM_LOG_DIR}/v1-migration.log"

#PM_STATUS_DIR     = "/var/devicemgr"
#PM_LIBRARY_DIR    = "#{PM_STATUS_DIR}/ServiceData"  # This is a symlink to the actual ProfileManager directory (defaults to /Library/Server/ProfileManager)
#PM_DATA_DIR       = "#{PM_LIBRARY_DIR}/Data"
#PM_FILE_STORE_DIR = "#{PM_DATA_DIR}/FileStore"
#PM_TMP_DIR        = "#{PM_DATA_DIR}/tmp"

ENV['SCHEMA'] = "/tmp/schema.rb"                    # This might be created whenever we rake the DB, so it needs to be outside of the server bundle
...
Rails::Initializer.run do |config|
  ...
  config.log_path = PM_LOG_PATH
  config.logger   = MDMLogger.new(PM_LOG_PATH, 1)
