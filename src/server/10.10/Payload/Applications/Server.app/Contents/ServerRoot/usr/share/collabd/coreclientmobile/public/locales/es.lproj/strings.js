...
populateStrings({
	...
	"_Document.Sidebar.Tags.Add.Name": "Añadir campo de texto de etiqueta",
	...
	"_FilterBar.Filter.Unread.Title": "No leídos",
	...
	"_GearMenu.General.Replace": "Reemplazar archivo…",
	...
	"_Error.People.Disabled": "La función de visualización de todas las personas está desactivada en este servidor.",
	"_Error.Projects.Disabled": "La función de visualización de todos los proyectos está desactivada en este servidor.",
	"_Error.AllActivity.Disabled": "La función de visualización de toda la actividad está desactivada en este servidor.",
	...
	"_Control.TrashIcon": "Icono de papelera",	
	"_Control.Done": "Aceptar",
	"_Control.Edit": "Editar",
	"_Control.Save": "Guardar",
	"_Control.Send": "Enviar",
	"_Control.OK": "Aceptar",
	"_Control.Close": "Cerrar",
	"_Control.Plus": "Más",
	"_Control.ShowDiff": "ShowDiff",		
	"_Control.Pagination.ShowAll": "Mostrar todo",
	"_Control.Gear": "Menú Acción",
	"_Control.MenuNavigation": "Navegación",
	"_Control.AccessRole.Popup": " menú desplegable",
	"_Control.Switch.On": "SÍ",
