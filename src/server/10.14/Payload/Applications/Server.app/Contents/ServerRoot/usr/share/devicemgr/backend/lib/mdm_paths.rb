...
PM_STATIC_URI_ROOT      = '/devicemanagement/static'
...
PM_LIBRARY_DIR          = "#{SERVER_LIBRARY_PATH}/ProfileManager"
  PM_CONFIG_DIR         = "#{PM_LIBRARY_DIR}/Config"
    ...
    PM_VERSION_UUID     = "#{PM_CONFIG_DIR}/VersionUUID"    # A UUID for this version of Server, changes with each run of deviceManagerCommon.sh
