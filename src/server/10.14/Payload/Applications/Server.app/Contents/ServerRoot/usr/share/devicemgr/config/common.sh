...
#           VersionUUID                     (A UUID for this version of Server, changes with each run of deviceManagerCommon.sh)
#           var/
...
PM_LIBRARY_DIR="$SERVER_LIBRARY_PATH/ProfileManager"
  PM_CONFIG_DIR="$PM_LIBRARY_DIR/Config"
    ...
    PM_VERSION_UUID="$PM_CONFIG_DIR/VersionUUID"
    PM_VAR_DIR="$PM_CONFIG_DIR/var"                   # Our replacement for /private/var (/Library/Server/ProfileManager/Config/var)
      ...
      PM_PG_SOCKET_MIGRATE_DIR="$PM_VAR_DIR/PostgreSQL-migration"
