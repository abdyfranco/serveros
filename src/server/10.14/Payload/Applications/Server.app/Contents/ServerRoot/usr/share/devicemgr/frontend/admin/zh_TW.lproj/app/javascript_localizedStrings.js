...
var localizedStrings = { /* The name of the Web Application itself. */
  ...
  "_device_enrollment_state_unenrollment_pending": "正在等待取消登記",
  ...
  "_task_type_clear_restrictions_passcode": "清除螢幕時間密碼",
  "_task_type_clear_restrictions_passcode_with_display_name": "清除螢幕時間密碼：%@1",
  ...
  "_combined_profile_pending_install": "等待中的安裝",
  ...
  "_combined_profile_pending_removal": "等待中的移除",
  ...
  /*  */
  "_certificate_knob_set_description": "使用此部分來指定您要在裝置上安裝的 PKCS1 和 PKCS12 憑證。加入您的公司憑證，以及其他用以認證裝置來連接網路所需的憑證。",
  ...
  "_enrollment_profile_device_groups_description": "自動將使用此描述檔登記的裝置新增至下列裝置群組",
  ...
  "_permissions_string_Allow enrollment of devices configured using Apple Configurator": "允許使用 Apple Configurator 設定的裝置在使用設定輔助程式期間登記",
  ...
  "_software_update_knobset_Allow non-admin users to purchase apps and install software updates": "允許非管理使用者購買 App 和安裝軟體更新",
  ...
  "_passcode_string_Force password reset": "強制重置密碼（僅 macOS）",
  "_passcode_string_force_password_reset_description": "下一個使用者認證期間強制重置密碼",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Time Machine": "時光機",
  ...
  "_macos_system_pref_pane_label_Wallet": "錢包與 Apple Pay",
  ...
  "_restrictions_string_Allow Screen Time": "允許螢幕時間（僅限監管）",
  ...
  "_ios_restriction_string_Allow password AutoFill (supervised only)": "允許自動填寫密碼（僅限監管）",
  "_ios_restriction_string_Require Face ID authentication for AutoFill (supervised only, Face ID only)": "自動填寫需要 Touch ID/Face ID 認證（僅限監管）",
  "_mac_restriction_string_Allow Touch ID to unlock device": "允許 Touch ID 解鎖裝置",
  "_mac_restriction_string_Allow proximity based password sharing requests": "允許密碼感應共享要求",
  "_mac_restriction_string_Allow password sharing": "允許密碼共享",
  "_mac_restriction_string_Allow password AutoFill": "允許自動填寫密碼",
  "_restriction_string_Allow password sharing": "允許密碼共享（僅限監管）",
  ...
  "_dock_setting_Minimize windows into application icon": "將視窗縮小到 App 圖像",
  "_dock_setting_Automatically hide and show the Dock": "自動隱藏及顯示 Dock",
  "_dock_setting_Show indicators for open apps": "顯示已打開的 App 指示器",
  "_dock_setting_Show recent apps in Dock": "在 Dock 中顯示最近使用過的 App",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Encrypt contents with FileVault": "使用「檔案保險箱」加密內容",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Allow only the following Dashboard widgets to run": "僅允許執行下列儀表板小工具",
  ...
  "_macos_restriction_string_Allow iCloud Drive": "允許「iCloud 雲碟」",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Mission Control": "指揮中心",
  ...
  "_smime_option_string_Allow user to enable/disable S/MIME signing": "允許使用者啟用或停用 S/MIME 簽署",
  "_smime_option_string_Allow user to modify S/MIME signing certificate": "允許使用者修改 S/MIME 簽署憑證",
  "_generic_string_Enable S/MIME Encryption": "預設啟用 S/MIME 加密",
  "_smime_option_string_Allow user to enable or disable S/MIME encryption": "允許使用者啟用或停用 S/MIME 加密",
  "_smime_option_string_Allow user to modify S/MIME encryption certificate": "允許使用者修改 S/MIME 加密憑證",
  ...
  /* This is a generic string used one or more times in the app. */
  "_unsupported_ios_version_for_app_distribution": "升級 iOS 並重新登記此裝置來啟用 App 分配。企業級 App 分配需要 iOS 5 或以上版本，VPP App 分配需要 iOS 9 或以上版本。",
  "_unsupported_osx_version_for_app_distribution": "升級 OS X 並重新登記此裝置來啟用 App 分配。企業級 App 分配需要 OS X 10.10 或以上版本，VPP App 分配需要 OS X 10.11 或以上版本。",

  /* This is a generic string used one or more times in the app. */
  "_generic_string_Re-enroll this device to enable enterprise application distribution": "重新登記此裝置來啟用 App 分配。",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Do not allow user to override Gatekeeper setting": "不允許使用者覆蓋「門禁」設定",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Prevents the user from temporarily overriding the Gatekeeper setting by control-clicking to install any app": "按住 Control 鍵來安裝 App，以防止使用者暫時覆蓋「門禁」設定。",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Gatekeeper Settings": "配置「門禁」設定",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Allow Apple Books (supervised only)": "允許「書籍」App（僅限監管）",

  "_generic_string_Allow Podcasts (supervised only)": "允許使用 Podcast（僅限監管）",

  /* This is a generic string used one or more times in the app. */
  "_generic_string_Allow explicit sexual content in Apple Books": "允許「書籍」App 中兒童不宜的成人內容",

  /* This is a generic string used one or more times in the app. */
  "_generic_string_Allow Shared Albums": "允許共享的相簿",
  "_restriction_string_allow_cloud_photo_library": "允許 iCloud 照片",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Allow Passbook while device locked": "允許在鎖定畫面上顯示「錢包」通知",
  ...
  "_restriction_string_Force automatic date and time": "強制日期和時間（僅限監管）",
  ...
  "_general_string_app_name_Wallet": "錢包",
  ...
  '_general_string_app_name_iCloud Drive': 'iCloud 雲碟',
  ...
  "_general_string_app_name_Measure": "測距儀",
  ...
  "_generic_string_VoiceOver": "旁白",
  "_generic_string_Zoom": "縮放",
  "_generic_string_Invert Colors": "反相顏色",
  "_generic_string_AssistiveTouch": "輔助觸控",
  ...
  "_generic_string_Allow MailDrop": "允許「郵包投送」",
  "_generic_string_Allow MailDrop for this account": "允許此帳號使用「郵包投送」",
  ...
  "_global_time_machine_knob_set_name": "時光機",
  "_global_time_machine_knob_set_description": "使用此部分來配置「時光機」設定。",
  ...
  '_generic_string_FileVault': "檔案保險箱",
  "_generic_string_Privacy": "隱私權",
  "_generic_string_Require FileVault": "需要「檔案保險箱」",
  "_generic_string_If not already enabled, FileVault will be enabled at the next logout": "若尚未啟用，則會在下次登出時啟用「檔案保險箱」",
  "_generic_string_Defer FileVault setup": "延遲「檔案保險箱」設定",
  "_generic_string_Defers FileVault setup until the current user logs out": "延遲「檔案保險箱」設定直到目前使用者登出",
  "_generic_string_Create recovery key": "製作個人復原密鑰",
  "_generic_string_Create a personal FileVault recovery key": "製作個人「檔案保險箱」復原密鑰",
  ...
  "_generic_string_Create a personal FileVault recovery key and use an institutional recovery key": "使用機構復原密鑰並製作個人「檔案保險箱」復原密鑰",
  "_generic_string_Creates a institutional recovery user using the FileVault Master keychain": "啟用透過機構鑰匙圈取用加密磁碟",
  "_generic_string_FileVault username": "指定「檔案保險箱」使用者名稱",
  "_generic_string_FileVault enabled user, current logged in user is used by default": "已啟用「檔案保險箱」的使用者，預設值是使用目前登入的使用者",
  "_generic_string_FileVault user password": "指定「檔案保險箱」使用者密碼",
  "_generic_string_Password for the FileVault enabled user": "已啟用「檔案保險箱」的使用者密碼",
  "_generic_string_Certificate that contains the public key from institutional recovery keychain": "DER 編碼憑證包含來自機構復原鑰匙圈的公用密鑰",
  "_generic_string_Require user to unlock FileVault after hibernation": "休眠後需要使用者解鎖「檔案保險箱」",
  "_generic_string_The user will be required to unlock FileVault when the computer awakes from hibernation": "當電腦從休眠喚醒後，使用者必須解鎖「檔案保險箱」",
  "_generic_string_Allow user to disable FileVault": "允許使用者停用「檔案保險箱」",
  ...
  "_filevault_setting_string_escrow_location_description": "將託管個人復原密鑰位置的簡短描述。此訊息將會在啟用「檔案保險箱」時對使用者顯示。",
  ...
  "_filevault_setting_string_Show personal recovery key": "顯示個人復原密鑰",
  ...
  "_generic_string_FileVault Enabled": "已啟用「檔案保險箱」",
  ...
  "_generic_string_VoiceOver Options": "「旁白」選項",
  "_generic_string_Enable VoiceOver:": "啟用「旁白」：",
  ...
  "_application_type_iOS & macOS": "iOS 與 macOS",
  ...
  "_generic_string_Volume Purchase": "App 與書籍的大量採購",
  ...
  "_assign_unified_apps_description": "您可以指定使用「App 與書籍的大量採購」所購買的 App，或加入到「描述檔管理程式」的內部 iOS 企業級 App。",
  "_assign_unified_apps_description_no_device_management": "您可以指定使用「App 與書籍的大量採購」所購買的 App。",
  "_assign_apps_to_devices_description": "您可以指定使用「App 與書籍的大量採購」所購買，適用於裝置的 App，或加入到「描述檔管理程式」的內部 iOS 企業級 App。",
  "_assign_unified_books_description": "您可以指定使用「App 與書籍的大量採購」所購買的書籍。",
  "_assign_inhouse_enterprise_books_description": "您可以指定加入到「描述檔管理程式」的內部企業級書籍",
  "_generic_string_Purchased": "已購買",
  "_generic_string_Available_Licenses": "可用",
  "_generic_string_Assignment": "指定",
  "_generic_string_Groups": "群組",
  "_generic_string_profile_manager_apps_feature_description": "「描述檔管理程式」可讓您輕易地指定和分配透過「App 與書籍的大量採購」所購買的 App 給使用者和群組。您也可以將 iOS 和 macOS 的企業級 App 分配給已登記的裝置。",
  "_generic_string_profile_manager_apps_feature_description_no_device_management": "「描述檔管理程式」可讓您輕易地指定和分配透過「App 與書籍的大量採購」所購買的 App 給使用者和群組。",
  "_generic_string_profile_manager_books_feature_description": "「描述檔管理程式」可讓您輕易地指定透過「App 與書籍的大量採購」所購買的書籍給使用者和群組。您也可以將「企業級書籍」分配給已登記的裝置。",
  "_generic_string_profile_manager_books_feature_description_no_device_management": "「描述檔管理程式」可讓您輕易地指定和分配透過「App 與書籍的大量採購」所購買的書籍給使用者和群組。",
  ...
  "_vpp_enrollment_status_This user was enrolled to receive content on <od_vpp_status_updated_at>.": "已在 %@ 登記此使用者來接收內容。",
  ...
  "_user_group_enrollment_info_These users were enrolled to receive content on <time>": "已在 %@ 登記這些使用者來接收內容",
  ...
  "generic_string_authorized_users_exceeds_available_licenses_for_single_app_appleid_assignment": "您沒有足夠的拷貝（%@）可配置給此群組中的所有使用者。您現在可以繼續 App 的指定作業，而拷貝將會在可用時自動配置。App 拷貝會根據使用者接受「VPP 管理分配」登記的時間，按時間先後的順序進行配置。",
  ...
  "generic_string_authorized_users_exceeds_available_licenses_for_multiple_apps_appleid_assignment": "您沒有足夠的拷貝（%@ 個 App）可配置給此群組中的所有使用者。您現在可以繼續 App 的指定作業，而拷貝將會在可用時自動配置。App 拷貝會根據使用者接受「VPP 管理分配」登記的時間，按時間先後的順序進行配置。",
  ...
  "generic_string_authorized_users_exceeds_available_licenses_for_multiple_apps_mixed_assignment": "您沒有足夠的拷貝（%@ 個 App）可供此群組的所有使用者與其裝置使用。您現在可以繼續 App 的指定作業，而拷貝將會在可用時自動配置。App 拷貝會根據使用者接受「VPP 管理分配」登記的時間順序、指定「管理式 Apple ID」完整名稱的字母順序，以及裝置名稱的字母順序來配置給使用者。",
  ...
  "_app_assignment_insufficient_licenses_warning_user_for_single_app_appleid_assignment": "您沒有「%@」的拷貝可立即配置給此使用者。您現在可以繼續 App 的指定作業，而拷貝將會在可用時自動配置。App 拷貝會根據使用者接受「VPP 管理分配」登記的時間，按時間先後的順序進行配置。",
  ...
  "_app_assignment_insufficient_licenses_warning_user_for_multiple_apps_appleid_assignment": "您沒有足夠的拷貝（%@ 個 App）可立即配置給此使用者。您現在可以繼續 App 的指定作業，而拷貝將會在可用時自動配置。App 拷貝會根據使用者接受「VPP 管理分配」登記的時間，按時間先後的順序進行配置。",
  ...
  "_app_assignment_insufficient_licenses_warning_user_for_multiple_apps_mixed_assignment": "您沒有足夠的拷貝（%@ 個 App）可立即配置給此使用者與其裝置。您現在可以繼續 App 的指定作業，而拷貝將會在可用時自動配置。App 拷貝會根據使用者接受「VPP 管理分配」登記的時間順序、指定「管理式 Apple ID」完整名稱的字母順序，以及裝置名稱的字母順序來配置給使用者。",
  ...
  "generic_string_authorized_users_exceeds_available_licenses_for_single_book_appleid_assignment": "您沒有足夠的拷貝（%@）可配置給此群組中的所有使用者。您現在可以繼續書籍的指定作業，而拷貝將會在可用時自動配置。書籍拷貝會根據使用者接受「VPP 管理分配」登記的時間，按時間先後的順序進行配置。",
  ...
  "generic_string_authorized_users_exceeds_available_licenses_for_multiple_books_appleid_assignment": "您沒有足夠的拷貝（%@ 本書）可配置給此群組中的所有使用者。您現在可以繼續書籍的指定作業，而拷貝將會在可用時自動配置。書籍拷貝會根據使用者接受「VPP 管理分配」登記的時間，按時間先後的順序進行配置。",
  ...
  "generic_string_authorized_users_exceeds_available_licenses_for_multiple_books_mixed_assignment": "您沒有足夠的拷貝（%@ 本書）可配置給此群組中的所有使用者。您現在可以繼續書籍的指定作業，而拷貝將會在可用時自動配置。書籍拷貝會根據使用者接受「VPP 管理分配」登記的時間順序，以及指定「管理式 Apple ID」完整名稱的字母順序來配置給使用者。",

  "_book_assignment_insufficient_licenses_warning_user_for_single_book_appleid_assignment": "您沒有「%@」的拷貝可立即配置給此使用者。您現在可以繼續書籍的指定作業，而拷貝將會在可用時自動配置。書籍拷貝會根據使用者接受「VPP 管理分配」登記的時間，按時間先後的順序進行配置。",
  ...
  "_book_assignment_insufficient_licenses_warning_user_for_multiple_books_appleid_assignment": "您沒有足夠的拷貝（%@ 本書）可立即配置給此使用者。您現在可以繼續書籍的指定作業，而拷貝將會在可用時自動配置。書籍拷貝會根據使用者接受「VPP 管理分配」登記的時間，按時間先後的順序進行配置。",
  ...
  "_book_assignment_insufficient_licenses_warning_user_for_multiple_books_mixed_assignment": "您沒有足夠的拷貝（%@ 本書）可立即配置給此使用者。您現在可以繼續書籍的指定作業，而拷貝將會在可用時自動配置。書籍拷貝會根據使用者接受「VPP 管理分配」登記的時間順序，以及指定「管理式 Apple ID」完整名稱的字母順序來配置給使用者。",
  ...
  "_dep_configuration_require_enrollment": "不允許使用者略過登記步驟",
  "_dep_configuration_require_enrollment_hint": "需要裝置在完成設定前至 MDM 登記",
  "_dep_configuration_Prevent unenrollment": "防止取消登記",
  ...
  '_dep_setup_assistant_option_True Tone Display': '原彩顯示',
  ...
  "_skip_setup_option_FileVault": "檔案保險箱",
  ...
  "_dep_setup_option_iMessage & FaceTime": "iMessage 與 FaceTime",
  "_dep_setup_option_Choose Your Look": "選擇您的外觀",
  "_dep_setup_option_Screen Time": "螢幕時間",
  "_dep_setup_option_Keep Your Device Up to Date": "持續更新裝置",
  "_dep_setup_option_Set Up Cellular": "設定行動數據",
  ...
  "_generic_string_Enable AssistiveTouch": "啟用「輔助觸控」",
  ...
  "_push_apps_picker_string_push_apps_to_user_group_description": "您可以推播指定的 App Store App 或企業級 App。所選的 App 將會推播至此群組的所有合格使用者裝置。",
  "_push_apps_picker_string_push_apps_to_user_description": "您可以推播指定的 App Store App 或企業級 App。所選的 App 將會推播至此使用者的合格裝置。",
  "_push_apps_picker_string_push_apps_to_device_description": "您可以推播指定的 App Store App 或企業級 App。所選的 App 將會推播至裝置。",
  "_push_apps_picker_string_push_apps_to_device_group_description": "您可以推播指定的 App Store App 或企業級 App。所選的 App 將會推播至此群組中的所有合格裝置。",
  ...
  "_generic_string_The selected books will be pushed to all eligible devices of enrolled users.": "所選的書籍將會推播到已登記之使用者的所有合格裝置上。",
  "_generic_string_The selected books will be pushed to all eligible devices of the enrolled user.": "所選的書籍將會推播到已登記之使用者的所有合格裝置上。",
  "_generic_string_The selected books are pushed to the user's eligible devices once they enroll in VPP Managed Distribution.": "當使用者登記「VPP 管理分配」之後，所選的書籍會推播到使用者的合格裝置上。",
  "_generic_string_1 user's eligible devices will receive the selected books once they enrolled in VPP Managed Distribution.": "使用者登記「VPP 管理分配」之後，1 個使用者的合格裝置將會接收到所選的書籍。",
  "_generic_string_<count> users' eligible devices will receive the selected books once they enrolled in VPP Managed Distribution.": "使用者登記「VPP 管理分配」之後，%@1 個使用者的合格裝置將會接收到所選的書籍。",
  ...
  "_generic_string_Allow USB restricted mode (supervised only)": "允許裝置鎖定時使用 USB 配件（僅限監管）",
  ...
  "_restriction_string_Allow modifying eSIM settings (supervised only)": "允許修改 eSIM 設定（僅限監管）",
  ...
  "_restrictions_string_Allow managed apps to write contacts to unmanaged contacts accounts": "允許受管理的 App 將聯絡資訊寫入未管理的聯絡資訊帳號",
  "_restrictions_string_Allow unmanaged apps to read contacts from managed contacts accounts": "允許未管理的 App 從受管理的聯絡資訊帳號讀取聯絡資訊",
  "_restriction_string_Treat AirDrop as unmanaged destination": "將 AirDrop 視為未受管理的目標",
  "_restrictions_string_Allow Handoff": "允許「接力」",
  ...
  "_layout_macos_restriction_defer_software_udpates_prefix_label_width": "104",
  ...
  "_restriction_string_Allow setting up new nearby devices": "允許設定新的附近裝置（僅限監管）",
  "_restriction_string_Allow proximity based password sharing requests": "允許密碼感應共享要求（僅限監管）",
  ...
  "dep_accept_agreements_description": "您的方案代理和管理者必須登入「Apple 部署計劃」網站，並接受更新的許可協議才能重新啟用此服務。",
  ...
  "_enrollment_setting_allow_activation_lock": "在 MDM 登記後傳送「允許啟用鎖定」指令（僅限監管）",
  ...
  "_xsan_string_Automatic Mounts": "自動裝載",
  "_xsan_string_Only the following volumes": "僅限下列卷宗",
  "_xsan_string_Everything except the following volumes": "下列卷宗除外的所有項目",
  "_xsan_string_only_mount_description": "系統管理者可使用 xsanctl 的裝載指令來手動裝載未顯示在此列表中的卷宗",
  "_xsan_string_mount_everything_else_description": "系統管理者可使用 xsanctl 的裝載指令來手動裝載此陣列中的卷宗",
  "_layout_xsan_settings_automatic_button_types_button_width": "250",
  "_xsan_volume_name_placeholder": "/MyXsanVolume",
  "_xsan_string_Disallow distributed LAN client mount for the following volumes": "不允許下列卷宗分配 LAN 用戶端裝載",
  "_xsan_string_Prefer distributed LAN client mount for the following volumes": "偏好下列卷宗分配 LAN 用戶端裝載",
  "_xsan_string_Use distributed LAN client to mount volumes": "使用分配的 LAN 用戶端來裝置卷宗",
  ...
  "_exchange_knob_set_Use OAuth for authentication": "使用 OAuth 進行認證",
  "_exchange_knob_set_OAuth Sign in URL": "OAuth 登入 URL",
  ...
  "_vpn_string_DNS server addresses": "DNS 伺服器位址",
  "_vpn_string_DNS search domains": "DNS 搜尋網域",
  "_vpn_string_DNS supplemental match domains": "DNS 補充相符網域",
  "_vpn_string_Domain Name": "網域名稱",
  "_vpn_string_The primary domain of the tunnel": "通道的主要網域",
  "_vpn_string_Include supplemental domains in the resolver's list of search domains": "在解決程式的搜尋網域列表中包含補充網域",
  ...
  "_enrollment_settings_errors_header_single": "登記設定有 1 個錯誤",
  "_enrollment_settings_errors_header_multiple": "登記設定有 %@ 個錯誤",

  // Server Account Payload
  '_osxserver_account_knob_set_deprecation_notice': '此乘載資料已不適用，將會在未來版本的「描述檔管理程式」中移除。',
  "_layout_osxserver_account_knob_set_deprecation_notice_height": "45",
  "_osxserver_account_knob_set_name": "「macOS 伺服器」帳號",
  "_osxserver_account_knob_set_description": "使用此部分來設定「macOS 伺服器」文件提供者",
  "_osxserver_account_knob_set_num_lines": "2",
  "_osxserver_account_knob_set_string_default_account_description": "我的「macOS 伺服器」帳號",
  "_osxserver_account_knob_set_string_Account Description": "帳號描述",
  "_osxserver_account_knob_set_string_The display name of the Server Account": "「macOS 伺服器」帳號的顯示名稱",
  "_osxserver_account_knob_set_string_Hostname": "「macOS 伺服器」主機名稱或 IP 位址",
  "_osxserver_account_knob_set_string_The hostname of the Server": "「macOS 伺服器」的主機名稱或 IP 位址",
  "_osxserver_account_knob_set_string_Username": "使用者名稱",
  "_osxserver_account_knob_set_string_The username of the Server Account": "「macOS 伺服器」帳號的使用者名稱",
  "_osxserver_account_knob_set_string_Password": "密碼",
  "_osxserver_account_knob_set_string_The password for the Server Account": "「macOS 伺服器」帳號的密碼",
  ...
  "_no_enrolled_devices_warning_user": "此使用者沒有已登記的裝置。",
  "_no_enrolled_devices_warning_user_group": "此群組的成員沒有已登記的裝置。",
  "_no_enrolled_devices_warning_device_group": "此裝置群組中沒有已登記的裝置。",
  ...
  "_app_notification_settings_Critical Alerts": "重要提示",
  "_app_notification_settings_Show in CarPlay": "顯示於 CarPlay",
  ...
  "_app_notification_settings_grouping_type_byapp": "依照 App",
  "_app_notification_settings_grouping_type_off": "關閉",
  "_app_notification_settings_Notification Grouping": "通知分組",
  "_layout_app_notification_settings_grouping_type_button_width": "68",
  ...
  "_tvos_restriction_string_Allow Apple Books (supervised only)": "允許「書籍」App（僅限監管）",
  ...
  "_smart_card_knob_set_string_Require Smart Card": "需要智慧卡",
  "_smart_card_knob_set_enforce_smart_card_description": "需要智慧卡登入、認證和解鎖螢幕保護程式。",
  "_smart_card_knob_set_Enable screensaver on Smart Card removal": "移除智慧卡時啟用螢幕保護程式",
  ...
  "_tvos_airplay_knob_set_select_button_passcode_always": "數字密碼",
  ...
  "_tvos_airplay_knob_set_password_information": "* 您可以在「描述檔管理程式」中設定 AirPlay 密碼。請在「裝置」列中選取 Apple TV，然後導覽至「關於」標籤頁，並且展開「AirPlay」的部分",
  ...
  "_tvos_airplay_knob_set_password_warning": "此 Apple TV 未設定 AirPlay 密碼，且「密碼」安全性類型需要 AirPlay 密碼。您可以在「描述檔管理程式」中設定 AirPlay 密碼。請在「裝置」列中選取 Apple TV，然後導覽至「關於」標籤頁，並且展開「AirPlay」的部分。",
  ...
  "_content_caching_tab_header_Clients": "用戶端",
  "_content_caching_tab_header_Peers": "端口",
  "_content_caching_tab_header_Parents": "上層",
  "_content_caching_header_Cache Content For:": "快取內容：",
  "_layout_content_caching_content_cache_for_option_button_width": "350",
  "_content_caching_cache_content_for_devices using the same public IP address": "使用相同公用 IP 位址的裝置",
  "_content_caching_cache_content_for_devices using the same local networks": "使用相同區域網路的裝置",
  "_content_caching_cache_content_for_devices using custom local networks": "使用自定區域網路的裝置",
  "_content_caching_cache_content_for_devices using custom local networks with fallback": "使用自定區域網路回降的裝置",
  "_content_caching_header_My Local Networks:": "我的區域網路：",
  "_layout_content_caching_local_network_option_button_width": "300",
  "_content_caching_my_local_networks_option_use one public IP address": "使用一個公用 IP 位址",
  "_content_caching_my_local_networks_option_use custom public IP addresses": "使用自定公用 IP 位址",
  "_content_caching_header_Share content with:": "共享內容：",
  "_content_caching_share_content_with_option_content caches using the same public IP address": "使用相同公用 IP 位址的內容快取",
  "_content_caching_share_content_with_option_content caches using the same local networks": "使用相同區域網路的內容快取",
  "_content_caching_share_content_with_option_content caches using custom local networks": "使用自定區域網路的內容快取",
  "_content_caching_Listen Ranges": "聽取範圍",
  "_content_caching_IP address ranges for the custom local networks": "自定區域網路的 IP 位址範圍",
  "_content_caching_IP address ranges of the peers to accept connections from": "用來接收連線傳入的端口 IP 位址範圍",
  "_content_caching_IP address ranges of the peers to query content from": "用來查詢內容的端口 IP 位址範圍",
  ...
  "_content_caching_header_Cache Location": "快取位置",
  "_content_caching_data_path_description": "更改此設定不會自動將快取內容從舊位置移至新位置。預設為：路徑的結尾應為：/資源庫/Application Support/Apple/AssetCache/Data。",
  "_content_caching_header_Allow Internet Connection Sharing": "允許 Internet 連線共享",
  "_content_caching_tethered_caching_description": "允許使用 USB 與連接的 iOS 裝置共享此電腦的 Internet 連線和快取內容",
  ...
  "_content_caching_header_Port": "傳輸埠",
  "_content_caching_port_description": "內容快取服務用以接受上傳和下載要求的 TCP 連接埠。設為 0 來隨機選擇連接埠。",
  ...
  "_tvos_tv_remote_knob_set_num_lines": "2",
  ...
  "_ios_tv_remote_knob_set_description": "使用此部分來設定可透過「遙控器」App 來控制的 Apple TV 列表",
  ...
  "_region_name_Bolivia (Plurinational State of)": "玻利維亞",
  "_region_name_Bonaire, Sint Eustatius and Saba": "波奈、聖尤斯特歇斯與薩巴島",
  "_region_name_Bosnia and Herzegovina": "波士尼亞與赫塞哥維納",
  "_region_name_Botswana": "波札那",
  ...
  "_region_name_Burundi": "蒲隆地",
  "_region_name_Cabo Verde": "維德角",
  ...
  "_region_name_Congo (Democratic Republic of the)": "剛果民主共和國",
  ...
  "_region_name_Falkland Islands (Malvinas)": "福克蘭群島（馬維納斯）",
  ...
  "_region_name_Iran (Islamic Republic of)": "伊朗（伊斯蘭共和國）",
  ...
  "_region_name_Macedonia (the former Yugoslav Republic of)": "馬其頓",
  ...
  "_region_name_Micronesia (Federated States of)": "密克羅尼西亞群島",
  "_region_name_Moldova (Republic of)": "摩爾多瓦",
  "_region_name_Monaco": "摩納哥",
  "_region_name_Mongolia": "蒙古",
  "_region_name_Montenegro": "蒙特內哥羅",
  "_region_name_Montserrat": "蒙哲臘",
  ...
  "_region_name_Russian Federation": "俄羅斯",
  "_region_name_Rwanda": "盧安達",
  "_region_name_Saint Barthélemy": "聖巴瑟米",
  "_region_name_Saint Helena, Ascension and Tristan da Cunha": "聖赫勒拿、阿森松與特里斯坦達庫尼亞群島",
  "_region_name_Saint Kitts and Nevis": "聖克里斯多福及尼維斯",
  "_region_name_Saint Lucia": "聖露西亞",
  "_region_name_Saint Martin (French part)": "法屬聖馬丁",
  "_region_name_Saint Pierre and Miquelon": "聖皮埃爾和密克隆群島",
  ...
  "_region_name_Sierra Leone": "獅子山共和國",
  "_region_name_Singapore": "新加坡",
  "_region_name_Sint Maarten (Dutch part)": "荷屬聖馬丁",
  ...
  "_region_name_Taiwan, Province of China[a]": "台灣",
  "_region_name_Tajikistan": "塔吉克",
  "_region_name_Tanzania, United Republic of": "坦尚尼亞",
  ...
  "_region_name_United Kingdom of Great Britain and Northern Ireland": "英國",
  "_region_name_United States of America": "美國",
  "_region_name_United States Minor Outlying Islands": "美屬離島",
  "_region_name_Uruguay": "烏拉圭",
  "_region_name_Uzbekistan": "烏茲別克",
  "_region_name_Vanuatu": "萬那杜",
  "_region_name_Venezuela (Bolivarian Republic of)": "委內瑞拉",
  "_region_name_Viet Nam": "越南",
  "_region_name_Virgin Islands (British)": "英屬維京群島",
  "_region_name_Virgin Islands (U.S.)": "美屬維京群島",
  "_region_name_Wallis and Futuna": "瓦利斯群島和富圖那群島",
  ...
  "_language_name_Belarusian": "白俄羅斯",
  ...
  "_language_name_Bulgarian": "保加利亞",
  "_language_name_Burmese": "緬甸文",
  "_language_name_Catalan, Valencian": "加泰羅尼亞語；瓦倫西亞語",
  "_language_name_Chamorro": "查莫羅文",
  "_language_name_Chechen": "車臣文",
  "_language_name_Chichewa, Chewa, Nyanja": "齊切瓦文；尼昂加文",
  ...
  "_language_name_Divehi, Dhivehi, Maldivian": "迪貝喜文；馬爾地夫文",
  "_language_name_Dutch, Flemish": "荷蘭文；法蘭德斯文",
  "_language_name_Dzongkha": "宗卡文",
  "_language_name_English": "英文",
  "_language_name_Esperanto": "世界語",
  "_language_name_Estonian": "愛沙尼亞",
  "_language_name_Ewe": "埃維文",
  "_language_name_Faroese": "法羅群島",
  ...
  "_language_name_Greek (modern)": "希臘文（現代）",
  "_language_name_Guaraní": "瓜拉尼文",
  "_language_name_Gujarati": "古吉拉特文",
  "_language_name_Haitian, Haitian Creole": "海地文；海地克里奧文",
  "_language_name_Hausa": "豪薩文",
  "_language_name_Hebrew (modern)": "希伯來文（現代）",
  ...
  "_language_name_Kikuyu, Gikuyu": "基庫尤文",
  "_language_name_Kinyarwanda": "盧安達文",
  "_language_name_Kirghiz, Kyrgyz": "吉爾吉斯文",
  "_language_name_Komi": "科米文",
  "_language_name_Kongo": "剛果文",
  "_language_name_Korean": "韓文",
  "_language_name_Kurdish": "庫爾德文",
  "_language_name_Kuanyama, Kwanyama": "寬亞瑪文",
  "_language_name_Latin": "拉丁樂",
  "_language_name_Luxembourgish, Letzeburgesch": "盧森堡文",
  "_language_name_Ganda": "干達文",
  "_language_name_Limburgan, Limburger, Limburgish": "林堡文",
  "_language_name_Lingala": "林加拉文",
  "_language_name_Lao": "寮國文",
  "_language_name_Lithuanian": "立陶宛",
  "_language_name_Luba-Katanga": "盧巴加丹加文",
  "_language_name_Latvian": "拉脫維亞",
  "_language_name_Manx": "曼島文",
  "_language_name_Macedonian": "馬其頓",
  ...
  "_language_name_Navajo, Navaho": "納瓦霍文",
  "_language_name_North Ndebele": "北恩德貝勒文",
  "_language_name_Nepali": "尼泊爾",
  ...
  "_language_name_Sichuan Yi, Nuosu": "四川彝文",
  "_language_name_South Ndebele": "南恩德貝勒文",
  "_language_name_Occitan": "奧克西坦文",
  "_language_name_Ojibwa": "奧吉布瓦文",
  "_language_name_Church Slavic, Church Slavonic, Old Church Slavonic, Old Slavonic, Old Bulgarian": "教會斯拉夫文；古斯拉夫文；古保加利亞文；古教會斯拉夫文",
  "_language_name_Oromo": "奧羅莫文",
  "_language_name_Oriya": "歐利亞文",
  "_language_name_Ossetian, Ossetic": "奧塞梯文；奧克西坦文",
  "_language_name_Panjabi, Punjabi": "旁遮普文",
  "_language_name_Pali": "巴利文",
  "_language_name_Persian": "波斯文",
  "_language_name_Polabian": "波拉布語",
  "_language_name_Polish": "波蘭文",
  "_language_name_Pashto, Pushto": "普什圖文",
  "_language_name_Portuguese": "葡萄牙文",
  "_language_name_Quechua": "蓋楚瓦文",
  "_language_name_Romansh": "羅曼斯文",
  "_language_name_Rundi": "隆迪文",
  "_language_name_Romanian, Moldavian, Moldovan": "羅馬尼亞文；摩爾多瓦文",
  ...
  "_language_name_Serbian": "塞爾維亞",
  "_language_name_Gaelic, Scottish Gaelic": "蓋爾文；蘇格蘭蓋爾文",
  "_language_name_Shona": "紹納文",
  "_language_name_Sinhala, Sinhalese": "僧伽羅文",
  "_language_name_Slovak": "斯洛伐克文",
  "_language_name_Slovenian": "斯洛維尼亞",
  "_language_name_Somali": "索馬利文",
  "_language_name_Southern Sotho": "南索托語",
  "_language_name_Spanish, Castilian": "西班牙文；卡斯提爾文",
  ...
  "_language_name_Uighur, Uyghur": "維吾爾語",
  "_language_name_Ukrainian": "烏克蘭文",
  "_language_name_Urdu": "烏爾都文",
  ...
  "_language_name_Old English (ca. 450–1100)": "古英文（約 450-1100 年）",
  "_language_name_Angika": "安吉卡文",
  "_language_name_Apache languages": "阿帕切諸語言",
  "_language_name_Official Aramaic (700–300 BCE); Imperial Aramaic (700–300 BCE)": "官方阿拉姆語（公元前 700–300）；帝國阿拉姆語（公元前 700–300）",
  "_language_name_Mapudungun; Mapuche": "馬普切語",
  "_language_name_Arapaho": "阿拉帕霍文",
  "_language_name_Artificial languages": "人工語言",
  "_language_name_Arawak": "阿拉瓦克文",
  "_language_name_Asturian; Bable; Leonese; Asturleonese": "阿斯圖里亞斯；巴布爾；萊昂；阿斯圖萊昂",
  "_language_name_Athapascan languages": "阿薩帕斯坎諸語言",
  "_language_name_Australian languages": "澳大利亞諸語言",
  "_language_name_Awadhi": "阿瓦德文",
  "_language_name_Banda languages": "班達諸語言",
  "_language_name_Bamileke languages": "巴米累克諸語言",
  "_language_name_Baluchi": "俾路支文",
  "_language_name_Balinese": "峇里文",
  "_language_name_Basa": "巴薩文",
  "_language_name_Baltic languages": "波羅的諸語言",
  "_language_name_Beja; Bedawiyet": "貝加語；貝達威特語",
  "_language_name_Bemba": "本巴文",
  "_language_name_Berber languages": "柏柏爾諸語言",
  "_language_name_Bhojpuri": "博傑普爾文",
  "_language_name_Bikol": "比科爾文",
  "_language_name_Bini; Edo": "比尼語",
  "_language_name_Siksika": "西克西卡文",
  "_language_name_Bantu languages": "班圖諸語言",
  "_language_name_Braj": "布拉吉文",
  "_language_name_Batak languages": "巴塔克諸語言",
  "_language_name_Buriat": "布里亞特文",
  "_language_name_Buginese": "布吉文",
  "_language_name_Bilin; Blin": "比林語",
  "_language_name_Caddo": "卡多文",
  "_language_name_Central American Indian languages": "中美印第安諸語言",
  "_language_name_Galibi Carib": "加勒比文",
  "_language_name_Caucasian languages": "高加索諸語言",
  "_language_name_Cebuano": "宿霧文",
  "_language_name_Celtic languages": "凱爾特諸語言",
  ...
  "_language_name_Chipewyan; Dene Suline": "奇佩維安文",
  "_language_name_Cherokee": "柴羅基文",
  "_language_name_Cheyenne": "夏安文",
  "_language_name_Chamic languages": "佔語諸語言",
  "_language_name_Montenegrin": "蒙特內哥羅語",
  "_language_name_Coptic": "科普特曆",
  "_language_name_English based Creoles and pidgins": "克里奧爾文和皮欽文（英國）",
  "_language_name_French-based Creoles and pidgins": "克里奧爾文和皮欽文（法國）",
  "_language_name_Portuguese-based Creoles and pidgins": "克里奧爾文和皮欽文（葡萄牙）",
  "_language_name_Crimean Tatar; Crimean Turkish": "克里米亞韃靼文；克里米亞土耳其文",
  "_language_name_Creoles and pidgins": "克里奧爾文和皮欽文",
  "_language_name_Kashubian": "卡舒比文",
  "_language_name_Cushitic languages": "庫希特諸語言",
  "_language_name_Dakota": "達科他文",
  "_language_name_Dargwa": "達爾格瓦文",
  "_language_name_Land Dayak languages": "陸地達雅諸語言",
  "_language_name_Delaware": "德拉瓦州",
  "_language_name_Slave (Athapascan)": "史拉維文（阿薩帕斯坎文）",
  "_language_name_Dogrib": "多格里布文",
  "_language_name_Dinka": "丁卡文",
  "_language_name_Dogri": "多格拉文",
  "_language_name_Dravidian languages": "達羅毗荼諸語言",
  "_language_name_Lower Sorbian": "下索布文",
  "_language_name_Duala": "杜亞拉文",
  "_language_name_Middle Dutch (ca. 1050–1350)": "中古荷蘭文（約 1050-1350 年）",
  ...
  "_language_name_Middle English (1100–1500)": "中古英文（1100-1500 年）",
  "_language_name_Ewondo": "埃翁多文",
  "_language_name_Fang": "芳文",
  "_language_name_Fanti": "芳蒂文",
  "_language_name_Filipino; Pilipino": "菲律賓文",
  "_language_name_Finno-Ugrian languages": "芬蘭烏戈爾諸語言",
  "_language_name_Fon": "豐文",
  "_language_name_Middle French (ca. 1400–1600)": "中古法文（約 1400-1600 年）",
  "_language_name_Old French (842–ca. 1400)": "古法文（842-約 1400 年)",
  ...
  "_language_name_Germanic languages": "日耳曼諸語言",
  "_language_name_Geez": "吉茲文",
  "_language_name_Gilbertese": "吉爾伯特文",
  "_language_name_Middle High German (ca. 1050–1500)": "中古高地德文（約 1050-1500 年）",
  "_language_name_Old High German (ca. 750–1050)": "古高地德文（約 750-1050）",
  "_language_name_Gondi": "貢德文",
  "_language_name_Gorontalo": "哥倫打洛文",
  "_language_name_Gothic": "歌德文",
  "_language_name_Grebo": "格列博文",
  "_language_name_Ancient Greek (to 1453)": "古希臘文（至 1453 年）",
  "_language_name_Swiss German; Alemannic; Alsatian": "瑞士德語；阿勒曼尼語；阿爾薩斯",
  "_language_name_Gwichʼin": "吉維克琴文",
  "_language_name_Haida": "海達文",
  "_language_name_Hawaiian": "夏威夷文",
  "_language_name_Hiligaynon": "希利蓋儂文",
  "_language_name_Himachali languages; Western Pahari languages": "喜馬偕爾邦諸語言；西帕哈里諸語言",
  "_language_name_Hittite": "赫梯文",
  "_language_name_Hmong; Mong": "赫蒙文",
  "_language_name_Upper Sorbian": "上索布文",
  "_language_name_Hupa": "胡帕文",
  "_language_name_Iban": "伊班文",
  "_language_name_Ijo languages": "艾喬諸語言",
  "_language_name_Iloko": "伊洛幹諾文",
  "_language_name_Indic languages": "印度諸語言",
  "_language_name_Indo-European languages": "印歐諸語言",
  "_language_name_Ingush": "印古什文",
  "_language_name_Iranian languages": "波斯諸語言",
  ...
  "_language_name_Kachin; Jingpho": "克欽文",
  "_language_name_Kamba": "康巴文",
  "_language_name_Karen languages": "克倫諸語言",
  "_language_name_Kawi": "卡威文",
  "_language_name_Kabardian": "卡巴爾達文",
  "_language_name_Khasi": "卡西文",
  "_language_name_Khoisan languages": "科依桑諸語言",
  "_language_name_Khotanese; Sakan": "于闐文",
  ...
  "_language_name_Kru languages": "克魯諸語言",
  ...
  "_language_name_Austronesian languages": "南島諸語言",
  "_language_name_Masai": "馬賽文",
  "_language_name_Moksha": "莫克沙文",
  "_language_name_Mandar": "曼達文",
  "_language_name_Mende": "門德文",
  "_language_name_Middle Irish (900–1200)": "中古愛爾蘭文（900-1200 年）",
  "_language_name_Uncoded languages": "未編碼語言",
  "_language_name_Mon-Khmer languages": "孟高棉諸語言",
  ...
  "_language_name_Nahuatl languages": "納瓦特諸語言",
  "_language_name_North American Indian languages": "北美印第安諸語言",
  "_language_name_Neapolitan": "拿坡里文",
  "_language_name_Low German; Low Saxon": "低地德文；低地薩克遜文",
  "_language_name_Nepal Bhasa; Newari": "尼瓦爾文",
  "_language_name_Nias": "尼亞斯文",
  "_language_name_Niger-Kordofanian languages": "尼日爾科爾多凡諸語言",
  "_language_name_Niuean": "紐埃文",
  "_language_name_Nogai": "諾蓋文",
  "_language_name_Old Norse": "古北歐語",
  ...
  "_language_name_Ottoman Turkish (1500–1928)": "奧圖曼土耳其文（1500-1928 年）",
  "_language_name_Otomian languages": "奧托米諸語言",
  "_language_name_Papuan languages": "巴布亞諸語言",
  "_language_name_Pangasinan": "邦阿西楠文",
  "_language_name_Pahlavi": "婆羅缽文",
  "_language_name_Pampanga; Kapampangan": "邦板牙文",
  "_language_name_Papiamento": "帕皮亞門托文",
  "_language_name_Palauan": "帛琉文",
  "_language_name_Old Persian (ca. 600–400 B.C.)": "古波斯文（約公元前 600-400 年）",
  "_language_name_Philippine languages": "菲律賓諸語言",
  "_language_name_Phoenician": "腓尼基文",
  "_language_name_Pohnpeian": "波納佩文",
  "_language_name_Prakrit languages": "普拉克里特諸語言",
  "_language_name_Old Provençal (to 1500); Old Occitan (to 1500)": "古普羅旺斯文（至 1500 年）",
  "_language_name_Reserved for local use": "保留供本機使用",
  "_language_name_Rajasthani": "拉賈斯坦文",
  "_language_name_Rapanui": "拉帕努伊文",
  "_language_name_Rarotongan; Cook Islands Maori": "拉羅湯加文；庫克群島",
  "_language_name_Romance languages": "羅曼諸語言",
  ...
  "_language_name_South American Indian languages": "南美印第安諸語言",
  ...
  "_language_name_Semitic languages": "閃米特諸語言",
  "_language_name_Old Irish (to 900)": "古愛爾蘭文（至 900 年）",
  "_language_name_Sign languages": "手語",
  "_language_name_Shan": "撣文",
  "_language_name_Sidamo": "悉達摩文",
  "_language_name_Siouan languages": "蘇語諸語言",
  "_language_name_Sino-Tibetan languages": "漢藏諸語言",
  "_language_name_Slavic languages": "斯拉夫諸語言",
  "_language_name_Southern Sami": "南薩米文",
  "_language_name_Sami languages": "閃米諸語言",
  ...
  "_language_name_Songhai languages": "桑海諸語言",
  "_language_name_Sranan Tongo": "蘇利南湯加語",
  "_language_name_Serer": "塞雷爾文",
  "_language_name_Nilo-Saharan languages": "尼羅沙里諸語言",
  "_language_name_Sukuma": "蘇庫馬文",
  "_language_name_Susu": "蘇蘇文",
  "_language_name_Sumerian": "蘇美文",
  "_language_name_Classical Syriac": "古典敘利亞文",
  "_language_name_Syriac": "敘利亞文",
  "_language_name_Tai languages": "泰國諸語言",
  ...
  "_language_name_Altaic languages": "阿爾泰諸語言",
  "_language_name_Tuvalua": "圖瓦盧語",
  ...
  "_language_name_Wolaitta; Wolaytta": "瓦拉莫語",
  ...
  "_language_name_Blissymbols; Blissymbolics; Bliss": "布力辛博語",
  "_language_name_Zenaga": "澤納加文",
  "_language_name_Standard Moroccan Tamazight": "標準摩洛哥塔馬齊格特語",
  "_language_name_Zande languages": "贊德諸語言",
  "_language_name_Zuni": "祖尼文",
  "_language_name_No linguistic content; Not applicable": "沒有語言內容，不適用",
  "_language_name_Zaza; Dimili; Dimli; Kirdki; Kirmanjki; Zazaki": "扎扎；底米里；科得奇；科曼吉；扎扎其",
