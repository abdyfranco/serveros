...
def usage():
    ...
    print '--sourceVersion <ver> The version number of the old system (like 10.6.8 - 10.11). Since we support migration from 10.6.8,'
    print '                  10.11 installs.'
...
def main(argv):
    ...
    description = "serverSettings Restore Extra"
    version = "%prog v10.11"
