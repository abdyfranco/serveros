...
#define	TRACE_POSTGRESQL_LWLOCK_WAIT_START_ENABLED() \
	({ int _r = __dtrace_isenabled$postgresql$lwlock__wait__start$v1(); \
		__asm__ volatile(""); \
		_r; })
#define	TRACE_POSTGRESQL_LWLOCK_WAIT_UNTIL_FREE(arg0, arg1) \
do { \
	__asm__ volatile(".reference " TRACE_POSTGRESQL_TYPEDEFS); \
	__dtrace_probe$postgresql$lwlock__wait__until__free$v1$696e74$696e74(arg0, arg1); \
	__asm__ volatile(".reference " TRACE_POSTGRESQL_STABILITY); \
} while (0)
#define	TRACE_POSTGRESQL_LWLOCK_WAIT_UNTIL_FREE_ENABLED() \
	({ int _r = __dtrace_isenabled$postgresql$lwlock__wait__until__free$v1(); \
		__asm__ volatile(""); \
		_r; })
#define	TRACE_POSTGRESQL_LWLOCK_WAIT_UNTIL_FREE_FAIL(arg0, arg1) \
do { \
	__asm__ volatile(".reference " TRACE_POSTGRESQL_TYPEDEFS); \
	__dtrace_probe$postgresql$lwlock__wait__until__free__fail$v1$696e74$696e74(arg0, arg1); \
	__asm__ volatile(".reference " TRACE_POSTGRESQL_STABILITY); \
} while (0)
#define	TRACE_POSTGRESQL_LWLOCK_WAIT_UNTIL_FREE_FAIL_ENABLED() \
	({ int _r = __dtrace_isenabled$postgresql$lwlock__wait__until__free__fail$v1(); \
		__asm__ volatile(""); \
		_r; })
...
extern void __dtrace_probe$postgresql$lwlock__wait__until__free$v1$696e74$696e74(int, int);
extern int __dtrace_isenabled$postgresql$lwlock__wait__until__free$v1(void);
extern void __dtrace_probe$postgresql$lwlock__wait__until__free__fail$v1$696e74$696e74(int, int);
extern int __dtrace_isenabled$postgresql$lwlock__wait__until__free__fail$v1(void);
