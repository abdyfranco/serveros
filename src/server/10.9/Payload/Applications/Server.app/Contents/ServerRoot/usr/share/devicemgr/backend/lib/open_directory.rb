...
class OpenDirectory
  ...
  ODQSearchTypeUsersByODQuery   = 1
  ODQSearchTypeGroupsByODQuery  = 2
  ODQSearchTypeParentMembership = 3
  ODQSearchTypeChildMembership  = 4
  ODQSearchTypeFilterUsers      = 5
  ODQSearchTypeFilterGroups     = 6
