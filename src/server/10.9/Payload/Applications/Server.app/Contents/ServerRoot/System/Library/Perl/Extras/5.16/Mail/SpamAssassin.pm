...
$SUB_VERSION = (split(/\s+/,'$LastChangedDate: 2010-03-31 05:12:20 -0600 (Wed, 31 Mar 2010) $ updated by SVN'))[1];
...
sub new {
  ...
  $self->{DEF_RULES_DIR}	||= '/Library/Server/Mail/Data/scanner/spamassassin/3.003002';
