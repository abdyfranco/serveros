...
#
# Migrates jabberd 2.0 SQLite database into an initialized jabberd 2.2.14 database
...
my $BACKUP_DB_PATH = "/Library/Server/Messages/Data/sqlite/jabberd2.db.orig";
...
sub usage {
	...
	print "a jabberd 2.2.14 database.\n";
	print "\n";
...
# This is very specific to 2.0 -> 2.2.14 : Some SQLite columns now specify a "NOT NULL" restriction,
