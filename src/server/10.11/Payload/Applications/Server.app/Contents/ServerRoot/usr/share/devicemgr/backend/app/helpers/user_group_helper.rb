...
#-------------------------------------------------------------------------
  ...
  def self.get_complete_details(incoming_request)
    return { :user_group => { :retrieved => UserGroup.get_attributes_for_multiple_by_id(incoming_request['ids'], true) } }
  end
  ...
  def self.get_details_for_multiple(incoming_request)
    return { :user_group => { :retrieved => UserGroup.get_attributes_for_multiple_by_id(incoming_request['ids']) } }
  end
