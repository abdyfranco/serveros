...
$MDM_CONFIG['database']['dsn']      = "pgsql:host=/Library/Server/ProfileManager/Config/var/PostgreSQL/;dbname=devicemgr_v2m0;user=_devicemgr";
$MDM_CONFIG['database']['username'] = "_devicemgr";
