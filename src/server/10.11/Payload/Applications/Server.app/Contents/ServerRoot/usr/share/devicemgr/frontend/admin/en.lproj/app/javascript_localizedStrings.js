...
var localizedStrings = { /* The name of the Web Application itself. */
  ...
  "_groups_in_about_root_item_in_user_groups": "In Groups with assigned Restrictions, Settings, Apps or Books, or VPP enabled",
  ...
  "_software_update_knobset_allow_prerelease_installation": "Allow installation of OS X beta releases",
  ...
  /* This is a generic string used one or more times in the app. */
  "_passcode_string_maximum_failed_attempts_description": "Number of passcode entry attempts allowed before all data on device will be erased (iOS) or locked (OS X)",
  "_passcode_string_failed_attempt_timeout_label": "Delay after failed login attempts (OS X only)",
  ...
  /* This is a generic string used one or more times in the app. */
  "_remove_osx_app_from_library_description": "The app will be removed from your library. Existing assignments to users, groups, device groups, and OS X devices will be removed.",
  ...
  "_generic_string_The apps will be removed from all devices.": "OS X apps will be removed from your library and iOS apps will be removed your library and all devices.",
  ...
  "_generic_string_profile_manager_apps_feature_description": "Profile Manager makes it easy to assign and distribute apps purchased through the Volume Purchase Program to users and groups. You can also distribute enterprise apps for iOS and OS X to enrolled devices.",
  ...
  "_button_label_Add EduClass": "Add Class",
  ...
  "_dep_configuration_Requires supervision on iOS": "Requires supervision on iOS",
  ...
  "_osx_account_setup_options_header": "OS X Account Setup Assistant Options",
  ...
  "_osx_admin_account_info_header": "Managed OS X Administrator Account",
  "_osx_account_setup_options_create_admin_account": "Create managed OS X administrator account",
  ...
  "_scep_string_Certificate Expiration Notification Threshold (OS X only)": "Certificate Expiration Notification Threshold (OS X only)",
  ...
  "_exchange_string_Enable S/MIME": "Enable S/MIME",
  "_exchange_string_Support S/MIME for this account": "Support S/MIME for this account",
  ...
  /* Always On */
  "_vpn_always_on_use_same_tunnel_configuration": "Use same tunnel configuration for Cellular and WiFi",
  ...
  "_change_modes_warning_message_one_osx_vpp_app_selected": "Installation mode of \"%@\" will not be updated because OS X VPP apps are eligible for Manual installation mode only",
  "_change_modes_warning_message_multiple_osx_vpp_app_selected": "Installation mode of %@ apps will not be updated because OS X VPP apps are eligible for Manual installation mode only",
  "_change_modes_warning_message_enterprise_app_osx_vpp_app_selected": "Installation mode of %@ apps will not be updated because iOS enterprise apps and OS X VPP apps have fixed installation modes",
  ...
  '_managed_apple_id_already_assigned_error_header': 'Duplicate Managed Apple ID',
  '_managed_apple_id_already_assigned_error_description': '%@ is already assigned to %@. Enter a different Managed Apple ID for %@.',

  // OS X Server Account Payload
  "_osxserver_account_knob_set_name": "OS X Server Accounts",
  "_osxserver_account_knob_set_description": "Use this section to configure OS X Server document providers",
  "_osxserver_account_knob_set_num_lines": "2",
  "_osxserver_account_knob_set_string_default_account_description": "My OS X Server Account",
  "_osxserver_account_knob_set_string_Account Description": "Account Description",
  "_osxserver_account_knob_set_string_The display name of the OS X Server Account": "The display name for the OS X Server Account",
  "_osxserver_account_knob_set_string_Hostname": "OS X Server Host Name or IP Address",
  "_osxserver_account_knob_set_string_The hostname of the OS X Server": "The Host Name or IP Address of the OS X Server",
  "_osxserver_account_knob_set_string_Username": "User Name",
  "_osxserver_account_knob_set_string_The username of the OS X Server Account": "The user name of the OS X Server Account",
  "_osxserver_account_knob_set_string_Password": "Password",
  "_osxserver_account_knob_set_string_The password for the OS X Server Account": "The password for the OS X Server Account",
  ...
  "_set_osx_os_type_for_device_assignable_application_confirmation": "This app will be made available for assignment and installation to users, groups, device groups and OS X devices. Existing assignments to iOS devices will be removed.",
  "_set_ios_os_type_for_device_assignable_application_confirmation": "This app will be made available for assignment and installation to users, groups, device groups and iOS devices. Existing assignments to OS X devices will be removed.",
