...
var localizedStrings = { /* The name of the Web Application itself. */
  ...
  "_restrictions_knob_set_name_osx": "访问限制 (OS X)",
  ...
  "_about_info_string_location_lat_long": "纬度：%@，经度：%@",
  ...
  "_groups_in_about_root_item_in_user_groups": "在分配了“访问限制”、“设置”、“应用”或“图书”，或者 VPP 已启用的群组中",
  ...
  "_software_update_knobset_allow_prerelease_installation": "允许安装发布的 OS X Beta 版本",
  ...
  /* This is a generic string used one or more times in the app. */
  "_passcode_string_maximum_failed_attempts_description": "在抹掉 (iOS) 或锁定 (OS X) 设备上的所有数据之前，所允许的密码输入失败次数",
  "_passcode_string_failed_attempt_timeout_label": "多次尝试登录失败后延迟（仅限 OS X）",
  ...
  /* This is a generic string used one or more times in the app. */
  "_remove_osx_app_from_library_description": "应用将从您的资源库中移除。用户、群组、设备群组和 OS X 设备现有的分配将被移除。",
  "_remove_ios_app_from_library_description": "应用将从您的资源库中移除。用户、群组、设备群组和 iOS 设备现有的分配将被移除。",
  "_generic_string_The apps will be removed from all devices.": "OS X 应用将从您的资料库中移除，并且 iOS 应用将从您的资料库和所有设备中移除。",
  ...
  "_generic_string_profile_manager_apps_feature_description": "描述文件管理器能够方便地将通过“批量购买计划”购买的应用分配和分发给用户和群组。您还可以将适用于 iOS 和 OS X 的企业级应用分发给已注册设备。",
  ...
  "_button_label_Add EduClass": "添加班级",
  ...
  "generic_string_authorized_users_exceeds_available_licenses_for_multiple_apps_mixed_assignment": "您没有足够可用的“%@”应用副本用于此群组中的所有用户及其设备。您现在可以继续分配应用，副本将在可用时自动分配。应用副本会根据用户接受 VPP 已管理的分发注册的时间顺序分配给用户，并按设备名称的字母顺序分配给设备。",

  "generic_string_authorized_users_exceeds_available_licenses_for_single_book": "您没有足够可用的“%@”副本用于此群组中的所有用户。您现在可以继续分配图书，副本将在可用时自动分配。图书副本会根据用户接受 VPP 已管理的分发注册的时间顺序进行分配。",
  "generic_string_authorized_users_exceeds_available_licenses_for_multiple_books": "您没有足够可用的“%@”图书副本用于此群组中的所有用户。您现在可以继续分配图书，副本将在可用时自动分配。图书副本会根据用户接受 VPP 已管理的分发注册的时间顺序进行分配。",
  ...
  "_app_assignment_insufficient_licenses_warning_user_for_multiple_apps_mixed_assignment": "您没有足够可用的“%@”应用副本以立即分配到此用户及其设备。您现在可以继续分配应用，副本将在可用时自动分配。应用副本会根据用户接受 VPP 已管理的分发注册的时间顺序分配给用户，并按设备名称的字母顺序分配给设备。",
  ...
  "_dep_configuration_Requires supervision on iOS": "要求对 iOS 进行监督",
  ...
  "_osx_account_setup_options_header": "OS X 帐户设置助理选项",
  ...
  "_osx_admin_account_info_header": "被管理的 OS X 管理员帐户",
  "_osx_account_setup_options_create_admin_account": "创建被管理的 OS X 管理员帐户",
  ...
  "_scep_string_Certificate Expiration Notification Threshold (OS X only)": "证书过期通知临界值（仅限 OS X）",
  ...
  "_exchange_string_Enable S/MIME": "启用 S/MIME",
  "_exchange_string_Support S/MIME for this account": "支持这个帐户的 S/MIME",
  ...
  /* Always On */
  "_vpn_always_on_use_same_tunnel_configuration": "对蜂窝移动网络和 WiFi 使用相同的隧道配置",
  ...
  "_change_modes_warning_message_one_osx_vpp_app_selected": "“%@”的安装模式将不会更新，因为 OS X VPP 应用仅具备使用手动安装模式的资格",
  "_change_modes_warning_message_multiple_osx_vpp_app_selected": "%@ 个应用的安装模式将不会更新，因为 OS X VPP 应用仅具备使用手动安装模式的资格",
  "_change_modes_warning_message_enterprise_app_osx_vpp_app_selected": "%@ 个应用的安装模式将不会更新，因为 iOS 企业级应用和 OS X VPP 应用具有固定的安装模式",

  "_enrollment_settings_errors_header_single": "注册设置有 1 个错误",
  "_enrollment_settings_errors_header_multiple": "注册设置有 %@ 个错误",
  '_managed_apple_id_already_assigned_error_header': '管理式 Apple ID 重复',
  '_managed_apple_id_already_assigned_error_description': '“%@”已分配给“%@”。请为“%@”输入其他管理式 Apple ID。',

  // OS X Server Account Payload
  "_osxserver_account_knob_set_name": "OS X Server 帐户",
  "_osxserver_account_knob_set_description": "使用此部分来配置 OS X Server 文稿提供者",
  "_osxserver_account_knob_set_num_lines": "2",
  "_osxserver_account_knob_set_string_default_account_description": "我的 OS X Server 帐户",
  "_osxserver_account_knob_set_string_Account Description": "帐户描述",
  "_osxserver_account_knob_set_string_The display name of the OS X Server Account": "OS X Server 帐户的显示名称",
  "_osxserver_account_knob_set_string_Hostname": "OS X Server 主机名或 IP 地址",
  "_osxserver_account_knob_set_string_The hostname of the OS X Server": "OS X Server 的主机名或 IP 地址",
  "_osxserver_account_knob_set_string_Username": "用户名",
  "_osxserver_account_knob_set_string_The username of the OS X Server Account": "OS X Server 帐户的用户名",
  "_osxserver_account_knob_set_string_Password": "密码",
  "_osxserver_account_knob_set_string_The password for the OS X Server Account": "OS X Server 帐户的密码",
  ...
  "_proxies_knob_set_string_Enable Web Proxy (HTTP)": "启用 Web 代理 (HTTP)",
  "_proxies_knob_set_string_Hostname or IP address and port number for web proxy": "Web 代理的主机名或 IP 地址及端口号",
  "_proxies_knob_set_string_Enable Secure Web Proxy (HTTPS)": "启用安全 Web 代理 (HTTPS)",
  "_proxies_knob_set_string_Hostname or IP address and port number for secure web proxy": "安全 Web 代理的主机名或 IP 地址及端口号",
  ...
  "_generic_string_Use Two Factor Authentication": "使用双重身份鉴定",
  ...
  "_set_osx_os_type_for_device_assignable_application_confirmation": "此应用将可分配和安装到用户、群组、设备群组和 OS X 设备。iOS 设备的现有分配将被移除。",
  "_set_ios_os_type_for_device_assignable_application_confirmation": "此应用将可分配和安装到用户、群组、设备群组和 iOS 设备。OS X 设备的现有分配将被移除。",
