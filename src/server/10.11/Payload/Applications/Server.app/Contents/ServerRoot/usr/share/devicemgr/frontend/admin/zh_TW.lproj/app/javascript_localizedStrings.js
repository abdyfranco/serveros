...
var localizedStrings = { /* The name of the Web Application itself. */
  ...
  "_restrictions_knob_set_name_osx": "限制（OS X）",
  ...
  "_enrollment_profile_device_groups_header": "設備群組",
  ...
  "_about_info_string_location_lat_long": "緯度：%@，經度：%@",
  ...
  "_groups_in_about_root_item_in_user_groups": "在「群組」中啟用指定的「限制」、「設定」、App 或「書籍」或 VPP",
  ...
  "_permissions_string_Allow enrollment of devices configured via DEP": "允許使用「裝置登記方案」設定的裝置在使用設定輔助程式期間登記",
  ...
  "_software_update_knobset_allow_prerelease_installation": "允許安裝 OS X beta 版",
  ...
  "_cellular_settings_string_access_point_proxy_server_description": "主機名稱或 IP 位址，以及代理伺服器的埠號",
  ...
  /* This is a generic string used one or more times in the app. */
  "_passcode_string_maximum_failed_attempts_description": "在清除（iOS）或鎖定（OS X）裝置上的所有資料之前，允許嘗試輸入密碼的次數",
  "_passcode_string_failed_attempt_timeout_label": "嘗試登入失敗後延遲（僅限 OS X）",
  ...
  "_restriction_string_allow_modifying_touchid": "允許修改 Touch ID 指紋（僅限監管）",
  ...
  '_generic_string_Allow screen observation by Classroom': '允許「課堂」監看螢幕（僅限監管）',
  ...
  "_generic_string_Restrict App Store to software updates only": "限制 App Store 執行 MDM 安裝的 App 和軟體更新",
  ...
  "device_detail_icloud_backup_date_format": "%Y 年 %B 月 %d 日，%p %i:%M",
  ...
  "_item_list_loading_devices": "正在載入設備⋯",
  ...
  /* This is a generic string used one or more times in the app. */
  "_remove_osx_app_from_library_description": "將從資料庫中移除 App。也會移除對使用者、群組、裝置群組和 OS X 裝置的現有指定。",
  "_remove_ios_app_from_library_description": "將從資料庫中移除 App。也會移除對使用者、群組、裝置群組和 iOS 裝置的現有指定。",
  "_generic_string_The apps will be removed from all devices.": "OS X App 將會從您的資料庫中移除，而 iOS App 將會從您的資料庫與所有裝置上移除。",
  ...
  "_app_assignment_mode_device": "設備",
  ...
  "_assign_unified_apps_description": "您可以指定透過「大量採購方案」購買的 App，或加入至「描述檔管理程式」的內部 iOS 企業級 App。",
  "_assign_unified_apps_description_no_device_management": "您可以指定使用「大量採購方案」購買的 App。",
  "_assign_apps_to_devices_description": "您可以指定透過「大量採購方案」購買的合格裝置 App，或加入至「描述檔管理程式」的內部 iOS 企業級 App。",
  "_assign_unified_books_description": "您可以指定使用「大量採購方案」購買的書籍。",
  ...
  "_generic_string_profile_manager_apps_feature_description": "「描述檔管理程式」可讓您輕易地指定和分配透過「大量採購方案」購買的 App 給使用者和群組。您也可以將 iOS 和 OS X 的企業級 App 分配給已登記的裝置。",
  ...
  "_generic_string_profile_manager_books_feature_description": "「描述檔管理程式」可讓您輕易地指定透過「大量採購方案」購買的書籍給使用者和群組。您也可以將「企業級書籍」分配給已登記的裝置。",
  "_generic_string_profile_manager_books_feature_description_no_device_management": "「描述檔管理程式」可讓您輕易地指定和分配透過「大量採購方案」購買的書籍給使用者和群組。",
  ...
  "_button_label_Add EduClass": "新增班級",
  ...
  "_assign_device_groups_to_edu_class": "選擇要加入到班級的「共享的 iPad」裝置群組",
  ...
  "_about_tab_software_updates_string_1 device": "1 部裝置",
  "_about_tab_software_updates_string_multiple_devices": "%@ 部裝置",
  ...
  "generic_string_authorized_users_exceeds_available_licenses_for_multiple_apps_device_assignment": "您沒有足夠拷貝（%@ 個 App）可配置給此群組中的所有使用者裝置。您現在可以繼續 App 的指定作業，而拷貝將會在可用時自動配置。App 拷貝會依裝置名稱以字母順序配置給裝置。",
  "generic_string_authorized_users_exceeds_available_licenses_for_multiple_apps_mixed_assignment": "您沒有足夠的拷貝（%@ 個 App）可配置給此群組中的所有使用者與其裝置。您現在可以繼續 App 的指定作業，而拷貝將會在可用時自動配置。App 拷貝會根據使用者接受「VPP 管理分配」登記的時間按時間先後的順序，以及依裝置名稱以字母順序來配置給使用者。",

  "generic_string_authorized_users_exceeds_available_licenses_for_single_book": "您沒有足夠的拷貝（%@）可配置給此群組中的所有使用者。您現在可以繼續書籍的指定作業，而拷貝將會在可用時自動配置。書籍拷貝會根據使用者接受「VPP 管理分配」登記的時間，按時間先後的順序進行配置。",
  "generic_string_authorized_users_exceeds_available_licenses_for_multiple_books": "您沒有足夠的拷貝（%@ 本書籍）可配置給此群組中的所有使用者。您現在可以繼續書籍的指定作業，而拷貝將會在可用時自動配置。書籍拷貝會根據使用者接受「VPP 管理分配」登記的時間，按時間先後的順序進行配置。",
  "_book_assignment_insufficient_licenses_warning_user_for_multiple_books_appleid_assignment": "您沒有足夠的拷貝（%@ 本書籍）可供立即配置給此使用者。您現在可以繼續書籍的指定作業，而拷貝將會在可用時自動配置。書籍拷貝會根據使用者接受「VPP 管理分配」登記的時間，按時間先後的順序進行配置。",
  "_book_assignment_insufficient_licenses_warning_user_for_single_book_appleid_assignment": "您沒有「%@」的拷貝可供立即配置給此使用者。您現在可以繼續書籍的指定作業，而拷貝將會在可用時自動配置。書籍拷貝會根據使用者接受「VPP 管理分配」登記的時間，按時間先後的順序進行配置。",
  ...
  "_app_assignment_insufficient_licenses_warning_user_for_single_app_appleid_assignment": "您沒有「%@」的拷貝可供立即配置給此使用者。您現在可以繼續 App 的指定作業，而拷貝將會在可用時自動配置。App 拷貝會根據使用者接受「VPP 管理分配」登記的時間，按時間先後的順序進行配置。",
  "_app_assignment_insufficient_licenses_warning_user_for_multiple_apps_device_assignment": "您沒有足夠的拷貝（%@ 個 App）可供立即配置給此使用者的裝置。您現在可以繼續 App 的指定作業，而拷貝將會在可用時自動配置。App 拷貝會依裝置名稱以字母順序配置給裝置。",
  "_app_assignment_insufficient_licenses_warning_user_for_multiple_apps_appleid_assignment": "您沒有足夠的拷貝（%@ 個 App）可供立即配置給此使用者。您現在可以繼續 App 的指定作業，而拷貝將會在可用時自動配置。App 拷貝會根據使用者接受「VPP 管理分配」登記的時間，按時間先後的順序進行配置。",
  "_app_assignment_insufficient_licenses_warning_user_for_multiple_apps_mixed_assignment": "您沒有足夠的拷貝（%@ 個 App）可供立即配置給此使用者與其裝置。您現在可以繼續 App 的指定作業，而拷貝將會在可用時自動配置。App 拷貝會根據使用者接受「VPP 管理分配」登記的時間按時間先後的順序，以及依裝置名稱以字母順序來配置給使用者。",

  "_app_assignment_insufficient_licenses_warning_device_group_for_multiple_apps_device_assignment": "您沒有足夠的拷貝（%@ 個 App）可供立即配置給此群組中的所有裝置。您現在可以繼續 App 的指定作業，而拷貝將會在可用時自動配置。App 拷貝會依裝置名稱以字母順序進行配置。",
  ...
  "_app_assignment_insufficient_licenses_warning_device_for_multiple_apps_device_assignment": "您沒有足夠的拷貝（%@ 個 App）可供立即配置給此裝置。您現在可以繼續 App 的指定作業，而拷貝將會在可用時自動配置。App 拷貝會依裝置名稱以字母順序進行配置。",
  "_app_assignment_insufficient_licenses_warning_device_for_single_app_device_assignment": "您沒有「%@」的拷貝可供立即配置給此裝置。您現在可以繼續 App 的指定作業，而拷貝將會在可用時自動配置。App 拷貝會依裝置名稱以字母順序進行配置。",
  ...
  "_dep_configuration_Requires supervision on iOS": "需要在 iOS 上監管",
  ...
  "_osx_account_setup_options_header": "OS X 帳號設定輔助程式選項",
  ...
  "_osx_admin_account_info_header": "受管理的 OS X 管理者帳號",
  "_osx_account_setup_options_create_admin_account": "建立受管理的 OS X 管理者帳號",
  ...
  "dep_accept_agreements_description": "您的方案代理和管理者必須登入「Apple 部署方案網站」，並接受更新的許可協議才能重新啟用此服務。",
  "dep_program_website": "Apple 部署方案網站",
  ...
  "_directory_string_Packet signing": "封包簽名",
  ...
  "_scep_string_Certificate Expiration Notification Threshold (OS X only)": "憑證到期通知臨界值（僅限 OS X）",
  ...
  "_exchange_string_Enable S/MIME": "啟用 S/MIME",
  "_exchange_string_Support S/MIME for this account": "讓此帳號支援 S/MIME",
  ...
  /* Always On */
  "_vpn_always_on_use_same_tunnel_configuration": "對行動網路和 WiFi 使用相同的通道設定",
  ...
  "_change_modes_warning_message_one_enterprise_app_selected": "「%@」的安裝模式將不會更新，因為 iOS 企業級 App 僅適用於「自動」安裝模式",
  "_change_modes_warning_message_multiple_enterprise_app_selected": "%@ 個 App 的安裝模式將不會更新，因為 iOS 企業級 App 僅適用於「自動」安裝模式",
  "_change_modes_warning_message_one_osx_vpp_app_selected": "「%@」的安裝模式將不會更新，因為 OS X VPP App 僅適用於「手動」安裝模式",
  "_change_modes_warning_message_multiple_osx_vpp_app_selected": "%@ 個 App 的安裝模式將不會更新，因為 OS X VPP App 僅適用於「手動」安裝模式",
  "_change_modes_warning_message_enterprise_app_osx_vpp_app_selected": "%@ 個 App 的安裝模式將不會更新，因為 iOS 企業級 App 與 OS X VPP App 有固定的安裝模式",

  "_enrollment_settings_errors_header_single": "登記設定有 1 個錯誤",
  "_enrollment_settings_errors_header_multiple": "登記設定有 %@ 個錯誤",
  '_managed_apple_id_already_assigned_error_header': '重複的管理式 Apple ID',
  '_managed_apple_id_already_assigned_error_description': '「%@」已指定至「%@」。請輸入「%@」的其他「管理式 Apple ID」。',

  // OS X Server Account Payload
  "_osxserver_account_knob_set_name": "OS X Server 帳號",
  "_osxserver_account_knob_set_description": "使用此部分來配置 OS X Server 文件提供者",
  "_osxserver_account_knob_set_num_lines": "1",
  "_osxserver_account_knob_set_string_default_account_description": "我的 OS X Server 帳號",
  "_osxserver_account_knob_set_string_Account Description": "帳號描述",
  "_osxserver_account_knob_set_string_The display name of the OS X Server Account": "OS X Server 帳號的顯示名稱",
  "_osxserver_account_knob_set_string_Hostname": "OS X Server 主機名稱或 IP 位址",
  "_osxserver_account_knob_set_string_The hostname of the OS X Server": "OS X Server 的主機名稱或 IP 位址",
  "_osxserver_account_knob_set_string_Username": "使用者名稱",
  "_osxserver_account_knob_set_string_The username of the OS X Server Account": "OS X Server 帳號的使用者名稱",
  "_osxserver_account_knob_set_string_Password": "密碼",
  "_osxserver_account_knob_set_string_The password for the OS X Server Account": "OS X Server 帳號的密碼",
  "_osxserver_account_knob_set_string_Documents Server Port": "文件伺服器傳輸埠",
  "_osxserver_account_knob_set_string_The port to connect to for the documents server": "文件服務所連接的傳輸埠",
  ...
  "_proxies_knob_set_string_Hostname or IP address and port number for web proxy": "主機名稱或 IP 位址，以及網頁代理的埠號",
  "_proxies_knob_set_string_Enable Secure Web Proxy (HTTPS)": "啟用安全網頁代理（HTTPS）",
  "_proxies_knob_set_string_Hostname or IP address and port number for secure web proxy": "主機名稱或 IP 位址，以及安全網頁代理的埠號",
  "_proxies_knob_set_string_Enable FTP Proxy": "啟用 FTP 代理",
  "_proxies_knob_set_string_Hostname or IP address and port number for FTP proxy": "主機名稱或 IP 位址，以及 FTP 代理的埠號",
  "_proxies_knob_set_string_Enable SOCKS Proxy": "啟用 SOCKS 代理",
  "_proxies_knob_set_string_Hostname or IP address and port number for SOCKS proxy": "主機名稱或 IP 位址，以及 SOCKS 代理的埠號",
  "_proxies_knob_set_string_Enable Streaming Proxy (RTSP)": "啟用連續播送代理（RTSP）",
  "_proxies_knob_set_string_Hostname or IP address and port number for streaming proxy": "主機名稱或 IP 位址，以及連續播送代理的埠號",
  "_proxies_knob_set_string_Enable Gopher Proxy": "啟用 Gopher 代理",
  "_proxies_knob_set_string_Hostname or IP address and port number for gopher proxy": "主機名稱或 IP 位址，以及 Gopher 代理的埠號",
  ...
  "_set_osx_os_type_for_device_assignable_application_confirmation": "此 App 將可以指定給使用者、群組、裝置群組和 OS X 裝置並進行安裝。將會移除對 iOS 裝置的現有指定。",
  "_set_ios_os_type_for_device_assignable_application_confirmation": "此 App 將可以指定給使用者、群組、裝置群組和 iOS 裝置並進行安裝。將會移除對 OS X 裝置的現有指定。",
  ...
  "_home_screen_layout_knob_set_description": "使用此部分來設定主畫面佈局。這些設定只會影響監管的裝置。",
