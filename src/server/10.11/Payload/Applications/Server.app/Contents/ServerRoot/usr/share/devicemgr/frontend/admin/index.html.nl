...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="/devicemanagement/console/sproutcore/foundation/nl/5d475283ce90bb393c35eb66b53934189a5d8553/resources/images/favicon.ico" type="image/x-icon" />
    ...
    BUILD_INFO = {
      ...
      buildNumber: '0a83c86099fe82a90292d28198ae1256bb1027bd',
      buildLocale: 'en',

      // the logical URL at which we are built, which JavaScript can use
      // to compute relative URLs to other files.
      currentUrl: "/devicemanagement/console/admin/nl/0a83c86099fe82a90292d28198ae1256bb1027bd/index.html",

      // whether or not we are in relative URL mode.
      useRelativeUrls: false,

      styles: {
        x2: ["/devicemanagement/console/admin/nl/0a83c86099fe82a90292d28198ae1256bb1027bd/stylesheet@2x-packed.css"],
        normal: ["/devicemanagement/console/admin/nl/0a83c86099fe82a90292d28198ae1256bb1027bd/stylesheet-packed.css"]
      },

      images: {
        x2: ["/devicemanagement/console/admin/nl/0a83c86099fe82a90292d28198ae1256bb1027bd/packed-1@2x.png"],
        normal: ["/devicemanagement/console/admin/nl/0a83c86099fe82a90292d28198ae1256bb1027bd/packed-1.png"]
      }
    };
    </script>
...
if (SC.setupBodyClassNames) SC.setupBodyClassNames() ;
  ...
  <div style="display:none">    <script type="text/javascript" src="/devicemanagement/console/admin/nl/0a83c86099fe82a90292d28198ae1256bb1027bd/javascript-packed.js"></script></div>
  <script type="text/javascript" src="/devicemanagement/console/admin/common/0a83c86099fe82a90292d28198ae1256bb1027bd/javascript-packed.js"></script>
