...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="/devicemanagement/console/sproutcore/foundation/es/adfacaea98ee3dd2300a628d8d48a0edf58dad24/resources/images/favicon.ico" type="image/x-icon" />
    ...
    BUILD_INFO = {
      ...
      buildNumber: '823d2b7c0b9d32bd92c10f09cccf1fab16770c5d',
      buildLocale: 'en',

      // the logical URL at which we are built, which JavaScript can use
      // to compute relative URLs to other files.
      currentUrl: "/devicemanagement/console/admin/es/823d2b7c0b9d32bd92c10f09cccf1fab16770c5d/index.html",

      // whether or not we are in relative URL mode.
      useRelativeUrls: false,

      styles: {
        x2: ["/devicemanagement/console/admin/es/823d2b7c0b9d32bd92c10f09cccf1fab16770c5d/stylesheet@2x-packed.css"],
        normal: ["/devicemanagement/console/admin/es/823d2b7c0b9d32bd92c10f09cccf1fab16770c5d/stylesheet-packed.css"]
      },

      images: {
        x2: ["/devicemanagement/console/admin/es/823d2b7c0b9d32bd92c10f09cccf1fab16770c5d/packed-1@2x.png"],
        normal: ["/devicemanagement/console/admin/es/823d2b7c0b9d32bd92c10f09cccf1fab16770c5d/packed-1.png"]
      }
    };
    </script>
...
if (SC.setupBodyClassNames) SC.setupBodyClassNames() ;
  ...
  <div style="display:none">    <script type="text/javascript" src="/devicemanagement/console/admin/es/823d2b7c0b9d32bd92c10f09cccf1fab16770c5d/javascript-packed.js"></script></div>
  <script type="text/javascript" src="/devicemanagement/console/admin/common/823d2b7c0b9d32bd92c10f09cccf1fab16770c5d/javascript-packed.js"></script>
