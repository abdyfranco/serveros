...
var localizedStrings = { /* The name of the Web Application itself. */
  ...
  "_task_type_logout_user_with_display_name": "注销用户：%@",
  ...
  /*  */
  "_mac_restrictions_knob_set_description": "使用此部分来指定与应用和内容限制有关的设置。（在安装配置描述文件后，用户将无法在其设备上修改这些设置。）",
  ...
  '_add_recipients_add_shared_ipad_groups': '添加“共用的 iPad”群组',
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Ethernet (macOS only)": "以太网（仅限 macOS）",
  ...
  "_restriction_string_allow_modifying_touchid": "允许修改 Touch ID 指纹（仅限被监督的设备）",
  ...
  '_generic_string_Allow screen observation by Classroom': '允许通过“课堂”进行屏幕观察（仅限被监督的设备）',
  '_generic_string_Allow screen viewing by Classroom': '允许修改被管理班级的 AirPlay 和“屏幕巡视”权限（仅限被监督的设备）',
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Allow explicit music, podcasts, and iTunes U": "允许回放儿童不宜的音乐、播客和 iTunes U",
  ...
  "_generic_string_Restrict App Store to software updates only": "限制 App Store 仅包含 MDM 已安装的应用和软件更新",
  ...
  "_layout_login_script_and_logout_script_label_width": "70",
  ...
  "_generic_string_Allow App Store app adoption": "允许 App Store 应用采用",
  ...
  "_button_label_Add Shared iPad Groups": "添加“共用的 iPad”群组",
  "_button_label_Remove Shared iPad Groups": "移除“共用的 iPad”群组",
  ...
  "_about_tab_software_updates_string_1 device": "1 个设备",
  "_about_tab_software_updates_string_multiple_devices": "%@ 个设备",
  ...
  "_restriction_string_Allow connection to unmanaged Wi-Fi networks": "允许连接到未被管理的 Wi-Fi 网络（仅限被监督的设备）",
  ...
  "_change_modes_warning_message_one_enterprise_app_selected": "“%@”的安装模式将不会更新，因为 iOS 企业级应用仅具备使用自动安装模式的资格",
  "_change_modes_warning_message_multiple_enterprise_app_selected": "%@ 个应用的安装模式将不会更新，因为 iOS 企业级应用仅具备使用自动安装模式的资格",
  "_change_modes_warning_message_one_osx_vpp_app_selected": "“%@”的安装模式将不会更新，因为 macOS VPP 应用仅具备使用手动安装模式的资格",
  "_change_modes_warning_message_multiple_osx_vpp_app_selected": "%@ 个应用的安装模式将不会更新，因为 macOS VPP 应用仅具备使用手动安装模式的资格",
  "_change_modes_warning_message_enterprise_app_osx_vpp_app_selected": "%@ 个应用的安装模式将不会更新，因为 iOS 企业级应用和 macOS VPP 应用具有固定的安装模式",
  ...
  "_home_screen_layout_knob_set_description": "使用此部分来配置主屏幕布局。这些设置将仅影响被监督的设备。",
  ...
  "_tvos_restriction_string_Restrict Incoming AirPlay Requests": "停用 AirPlay（仅限被监督的设备）",
  "_tvos_restriction_string_Restrict remote app pairing": "停用与“遥控器”应用配对（仅限被监督的设备）",
