...
populateStrings({
	...
	"_Login.LogIn": "登入",
	"_Login.LogOut": "登出",
	"_Login.LogIn_Sidebar": "登入側邊欄",	
	"_Login.LogOut_Sidebar": "登出側邊欄",		
	...
	"_Document.Sidebar.Info": "資訊",
	"_Document.Sidebar.Download": "下載",	
	...
	"_Document.Sidebar.Tags.Add.Name": "加入標記",
	"_Document.Sidebar.Tags.SuggestedTags": "建議標記",
	"_Document.Sidebar.Tags.NoSuggestions": "沒有建議",	
	...
	"_Error.General.Database.Unabailable": "無法使用資料庫。",
	"_Error.General.Database.Contact": "請聯絡您的管理者或稍後再試一次。",
	"_Error.People.Unauthenticated": "請登入來檢視「所有人員」。",
	"_Error.AllActivity.Unauthenticated": "請登入來檢視「所有活動」。",
	...
	"_Accessibility.group.history": "歷程記錄群組",
	"_Accessibility.group.comment": "為群組加上註解",
	"_Accessibility.group.related": "相關群組",
	"_Accessibility.group.sidebar": "側邊欄群組",
	"_Accessibility.group.sharing": "共享群組",
	"_Accessibility.group.suggested": "建議的群組",
	"_Accessibility.group.editToolBar": "編輯工具列",
	"_Accessibility.color.selected": "已選取",
	"_Accessibility.Acls.All": "所有的使用者 Acl",
	"_Accessibility.Added.All": "加入的使用者 Acl",
	"_Accessibility.Navigation.Bar": "導覽列"
});
