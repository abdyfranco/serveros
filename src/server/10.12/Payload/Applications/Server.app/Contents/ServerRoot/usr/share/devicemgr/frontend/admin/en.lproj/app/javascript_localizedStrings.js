...
var localizedStrings = { /* The name of the Web Application itself. */
  ...
  "_task_type_logout_user_with_display_name": "LogOut User: %@",
  ...
  "_cellular_settings_string_access_point_proxy_server_description": "Hostname or IP address, and port number for the proxy server",
  ...
  /* This is a generic string used one or more times in the app. */
  "_generic_string_Ethernet (macOS only)": "Ethernet (macOS only)",
  ...
  "_restriction_string_allow_modifying_touchid": "Allow modifying Touch ID fingerprints (supervised only)",
  ...
  '_generic_string_Allow screen observation by Classroom': 'Allow screen observation by Classroom (supervised only)',
  '_generic_string_Allow screen viewing by Classroom': 'Allow modifying the AirPlay and View Screen permission for managed classes (supervised only)',
  ...
  "_generic_string_Restrict App Store to software updates only": "Restrict App Store to MDM installed apps and software updates",
  ...
  "_assign_device_groups_to_edu_class": "Choose device groups with Shared iPads to be added to the class",
  ...
  "_about_tab_software_updates_string_1 device": "1 device",
  "_about_tab_software_updates_string_multiple_devices": "%@ devices",
  ...
  "_restriction_string_Allow connection to unmanaged Wi-Fi networks": "Allow connecting to unmanaged Wi-Fi networks (supervised only)",
  ...
  "_content_filter_plugin_type_server_name_description": "Hostname or IP address or URL for the service",
  ...
  "_xsan_string_fs_name_servers_description": "Hostname or IP address of the file system name servers",
  ...
  "_directory_string_The hostname of the directory server": "The hostname of the directory server",
  ...
  "_change_modes_warning_message_one_enterprise_app_selected": "Installation mode of \"%@\" will not be updated because iOS enterprise apps are eligible for Automatic installation mode only",
  "_change_modes_warning_message_multiple_enterprise_app_selected": "Installation mode of %@ apps will not be updated because iOS enterprise apps are eligible for Automatic installation mode only",
  "_change_modes_warning_message_one_osx_vpp_app_selected": "Installation mode of \"%@\" will not be updated because macOS VPP apps are eligible for Manual installation mode only",
  "_change_modes_warning_message_multiple_osx_vpp_app_selected": "Installation mode of %@ apps will not be updated because macOS VPP apps are eligible for Manual installation mode only",
  "_change_modes_warning_message_enterprise_app_osx_vpp_app_selected": "Installation mode of %@ apps will not be updated because iOS enterprise apps and macOS VPP apps have fixed installation modes",
  ...
  "_proxies_knob_set_string_Hostname or IP address and port number for web proxy": "Hostname or IP address and port number for web proxy",
  "_proxies_knob_set_string_Enable Secure Web Proxy (HTTPS)": "Enable Secure Web Proxy (HTTPS)",
  "_proxies_knob_set_string_Hostname or IP address and port number for secure web proxy": "Hostname or IP address and port number for secure web proxy",
  "_proxies_knob_set_string_Enable FTP Proxy": "Enable FTP Proxy",
  "_proxies_knob_set_string_Hostname or IP address and port number for FTP proxy": "Hostname or IP address and port number for FTP proxy",
  "_proxies_knob_set_string_Enable SOCKS Proxy": "Enable SOCKS Proxy",
  "_proxies_knob_set_string_Hostname or IP address and port number for SOCKS proxy": "Hostname or IP address and port number for SOCKS proxy",
  "_proxies_knob_set_string_Enable Streaming Proxy (RTSP)": "Enable Streaming Proxy (RTSP)",
  "_proxies_knob_set_string_Hostname or IP address and port number for streaming proxy": "Hostname or IP address and port number for streaming proxy",
  "_proxies_knob_set_string_Enable Gopher Proxy": "Enable Gopher Proxy",
  "_proxies_knob_set_string_Hostname or IP address and port number for gopher proxy": "Hostname or IP address and port number for gopher proxy",
  ...
  "_home_screen_layout_knob_set_description": "Use this section to configure home screen layout. These settings will only affect supervised devices.",
  ...
  "_tvos_restriction_string_Restrict Incoming AirPlay Requests": "Disable AirPlay (supervised only)",
  "_tvos_restriction_string_Restrict remote app pairing": "Disable pairing with Remote app (supervised only)",
