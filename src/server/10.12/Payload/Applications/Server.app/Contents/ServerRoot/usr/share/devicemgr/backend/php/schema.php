...
//-------------------------------------------------------------------------
// Don't forget to grant appropriate privileges to the "deviceservice" role.
//-------------------------------------------------------------------------
...
$GLOBALS['gTableSchemas'] = [
  ...
  // Relations //
  ///////////////
  'app_configurations' => [                       // SELECT only
    'id'                  => 'int',
  ...
  'auto_join_profiles' => [                       // SELECT only
    'id'                 => 'int',
    'admin_temp_id'      => 'varchar',
    'created_at'         => 'timestamp',
    'updated_at'         => 'timestamp',
  ...
  'auto_join_profile_usage' => [                  // SELECT, INSERT
    'id'                   => 'int',
    'created_at'           => 'timestamp',
  ...
  'client_certificates' => [                      // SELECT, INSERT, UPDATE
    'id'                 => 'int',
    'device_id'          => 'int',
    'created_at'         => 'timestamp',
    'checkin_token'      => 'varchar',
    'scep_challenge'     => 'varchar',
    'status'             => 'varchar',
    'for_ota'            => 'boolean',
  ...
  'device_enrollment_settings' => [               // SELECT only
    'id'                    => 'int',
    'admin_temp_id'         => 'varchar',
    'created_at'            => 'timestamp',
    'updated_at'            => 'timestamp',
  ...
  'installed_ios_applications' => [               // SELECT only
    'id'                   => 'int',
    'mdm_target_type'      => 'varchar',
    'device_id'            => 'int',
    'mdm_task_id'          => 'int',
  ...
  'installed_profiles' => [                       // SELECT, INSERT, UPDATE, DELETE
    'id'                     => 'int',
    'mdm_target_id'          => 'int',
    'profile_id'             => 'int',
    'mdm_task_id'            => 'int',
  ...
  'lab_sessions' => [                             // SELECT, UPDATE (INSERT happens on specific child table)
    'id'                       => 'int',
    'admin_temp_id'            => 'varchar',
    'created_at'               => 'timestamp',
    'updated_at'               => 'timestamp',
  ...
  'library_item_metadata' => [                  // SELECT, UPDATE, INSERT (need INSERT to allow devices rows to be INSERTed)
    'id'                        => 'int',
    'dynamic_attributes'        => 'hash',
  ],
  'mdm_tasks' => [                              // SELECT, UPDATE, DELETE (DELETE happens in triggers)
    'id'                         => 'int',
  ...
  'network_lab_sessions' => [                   // SELECT, UPDATE, INSERT
    'id'                      => 'int',
    'admin_temp_id'           => 'varchar',
    'created_at'              => 'timestamp',
    'updated_at'              => 'timestamp',
  ...
  'od_nodes' => [                               // SELECT, INSERT (need INSERT for _find_or_create_user())
    'od_node_id'   => 'int',
    'od_node_name' => 'varchar',
  ],
  'owner_lab_sessions' => [                     // SELECT, UPDATE, INSERT
    'id'                      => 'int',
    'admin_temp_id'           => 'varchar',
    'created_at'              => 'timestamp',
    'updated_at'              => 'timestamp',
  ...
  'users' => [                                  // SELECT, INSERT (need INSERT for _find_or_create_user())
    'id'                 => 'int',
    'admin_temp_id'      => 'varchar',
    'created_at'         => 'timestamp',
    'updated_at'         => 'timestamp',
    ...
    'od_vpp_invite_code'    => 'varchar',
    'od_vpp_status_ext'     => 'varchar',
    'icon_url'           => 'text',
    'managed_apple_id'   => 'varchar',
  ],
  'view_current_scep_ca_cert' => [              // SELECT only
    'id'                 => 'int',
    'created_at'         => 'timestamp',
    'common_name'        => 'varchar',
    'expires_at'         => 'timestamp',
  ...
  'view_current_signing_identity' => [          // SELECT only
    'id'                 => 'int',
    'created_at'         => 'timestamp',
    'common_name'        => 'varchar',
    'expires_at'         => 'timestamp',
  ...
  'view_truth_app_configurations' => [          // SELECT only
    'device_id'         => 'integer',
    'unique_identifier' => 'varchar',
    'library_item_id'   => 'integer',
    'library_item_type' => 'varchar',
  ...
  'xsan_networks' => [                          // SELECT, UPDATE, INSERT
    'id'                        => 'int',
    'admin_temp_id'             => 'varchar',
    'created_at'                => 'timestamp',
    'updated_at'                => 'timestamp',
  ...
  'dm_fetch_edu_class_device_ids' => [
    'edu_class_id' => 'int'
  ],
  'dm_auto_update_all_profiles_for_mdm_target' => [
    'target_id' => 'int',
  ],
  '_dm_defer_batch_int_function_call' => [
    'fn'      => 'varchar',
    'intval'  => 'int'
  ],
  '_dm_objc_send' => [
