...
#-------------------------------------------------------------------------
  ...
  def self.table_name;  return 'data_files';  end
  ...
  def metadata; return AssetMetadata.find_by_id(self.id).metadata;  end
  ...
  def read;           return File.read(self.path);                    end
  def read_as_base64; return Base64.encode64(self.read);              end
