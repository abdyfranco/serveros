...
module MDMDynamicAttributes
  ...
  def self.included(base)
    ...
    base.class_eval do
      ...
      def after_find_with_mdm_da
        ...
        @dynamic_attributes = nil # Will just force us to read the JSON
        @_never_dynamic_keys = @@_never_dynamic_keys
        @_never_dynamic_keys |= self.class.class_variable_get(:@@never_dynamic_keys) if self.class.class_variable_defined?(:@@never_dynamic_keys)
      ...
      def fetch_dynamic_attributes
        unless @dynamic_attributes
          json = self.base_read_attribute(:dynamic_attributes)
          @dynamic_attributes = (json ? json.parse_internal_JSON : {})
          @dynamic_attributes_changed = false
        end
      ...
      def before_create_with_mdm_da
        ...
        unless result == false
          ...
          self.base_write_attribute(:dynamic_attributes, @dynamic_attributes.generate_internal_JSON) if @dynamic_attributes_changed
          @dynamic_attributes_changed = false
        end
        return result
      end
      ...
      def attributes_with_mdm_da
        ...
        return_hash.delete("dynamic_attributes")      # Remove the JSON, it's an implementation detail callers should never see
        return return_hash
      end
  ...
  def self.dynamic_attributes_models; return @@_included_models.dup;    end
  def self.never_dynamic_keys;        return @@_never_dynamic_keys.dup; end
